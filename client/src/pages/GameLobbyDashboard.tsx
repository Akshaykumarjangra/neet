  ...
  const chapterCounts = {
    ...
    Botany:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle, ch.chapterNumber, ch.classLevel || "11") === "Botany"
      ).length ?? 19,
    Zoology:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle, ch.chapterNumber, ch.classLevel || "11") === "Zoology"
      ).length ?? 19,
  };
