  ...
  const chapterCounts = {
    ...
    Botany:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle, ch.chapterNumber, ch.classLevel?.toString() ?? "") === "Botany"
      ).length ?? 19,
    Zoology:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle, ch.chapterNumber, ch.classLevel?.toString() ?? "") === "Zoology"
      ).length ?? 19,
  };
