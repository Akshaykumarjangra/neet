  ...
  const chapterCounts = {
    ...
    Botany:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle || "", ch.chapterNumber ?? 0, ch.classLevel || "") === "Botany"
      ).length ?? 19,
    Zoology:
      biologyLibraryChapters.filter(
        (ch) =>
          categorizeBiologyChapter(ch.chapterTitle || "", ch.chapterNumber ?? 0, ch.classLevel || "") === "Zoology"
      ).length ?? 19,
  };
