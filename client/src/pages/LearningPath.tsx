...
export default function LearningPath() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-7xl">
        <Paywall
          feature="AI-Powered Learning Path"
          description="Unlock your personalized NEET roadmap. Our AI analyzes your performance to create a custom study sequence that maximizes your score."
          variant="fullpage"
        >
          {/* Hero Section */}
          <motion.div
                  ...
                  {data?.allChapters.map((chapter, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Card
                          className={`ml-16 glass-panel hover-elevate active-elevate-2 transition-all ${chapter.isLocked ? 'opacity-60' : ''
