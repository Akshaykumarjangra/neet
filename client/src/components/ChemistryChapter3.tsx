...
// Fetch questions from database for Classification of Elements (topicId: 2104)
const { data: dbQuestions, isLoading: questionsLoading } = useQuery<Question[]>({
  queryKey: ['/api/questions', 'topicId', '2104'],
  queryFn: async () => {
    const response = await fetch('/api/questions?topicId=2104');
