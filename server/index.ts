...
console.log("[DEBUG] DB_URL_HOST:", process.env.DATABASE_URL ? new URL(process.env.DATABASE_URL).hostname : "MISSING");
console.log("[DEBUG] PROD_DB_URL_HOST:", process.env.PROD_DATABASE_URL ? new URL(process.env.PROD_DATABASE_URL).hostname : "MISSING");
