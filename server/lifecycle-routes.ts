...
const DRIP_TEMPLATES: Record<string, DripEmail> = {
  welcome: {
    ...
    <a href="https://nanoschool.in/dashboard" style="background:#6366f1;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;margin-top:16px;">Start Learning →</a>`,
  },
  first_test_reminder: {
    ...
    <a href="https://nanoschool.in/mock-tests" style="background:#6366f1;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;">Take Mock Test →</a>`,
  },
  inactive_3_days: {
    ...
    <a href="https://nanoschool.in/practice" style="background:#ef4444;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;">Quick Practice →</a>`,
  },
  milestone_approaching: {
    ...
    <a href="https://nanoschool.in/practice" style="background:#22c55e;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;">Keep Going →</a>`,
  },
  high_score_nps: {
    ...
    <p><a href="https://nanoschool.in/feedback?rating=10">😍 Definitely!</a> | <a href="https://nanoschool.in/feedback?rating=7">😊 Probably</a> | <a href="https://nanoschool.in/feedback?rating=4">😐 Maybe</a></p>`,
  },
  winback: {
    ...
    <a href="https://nanoschool.in/pricing?code=COMEBACK50" style="background:#8b5cf6;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;">Claim Offer →</a>`,
  },
};
...
async function sendEmail(to: string, template: DripEmail, vars?: Record<string, string>) {
  ...
  try {
    await transporter.sendMail({
      from: process.env.SMTP_FROM || '"ZERO AI NEET" <noreply@nanoschool.in>',
      to,
