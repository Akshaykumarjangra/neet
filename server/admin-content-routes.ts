...
router.get("/topics", requireAdminOrMentor, async (req, res) => {
  try {
    ...
    // Replaced N+1 queries with a single batched query using LEFT JOIN and GROUP BY
    // to dramatically improve backend execution performance when fetching topics and their question counts.
