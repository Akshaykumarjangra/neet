...
test.describe('User Journey', () => {
    ...
    test('should load the home page successfully', async ({ page }) => {
        ...
        await expect(page.getByText(/Master NEET with AI/i).or(page.getByTestId('button-cta-signup'))).toBeVisible();
    ...
    test('should navigate to pricing', async ({ page }) => {
        ...
        await expect(page.locator('h1, h2').filter({ hasText: /Pricing/i }).first().or(page.getByTestId('text-pricing-title'))).toBeVisible();
    });
