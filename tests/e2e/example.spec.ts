...
test.describe('User Journey', () => {
    ...
    test('should load the home page successfully', async ({ page }) => {
        ...
        await expect(page.locator('text=Master NEET').or(page.getByTestId('text-hero-headline')).first()).toBeVisible();
    ...
    test('should navigate to pricing', async ({ page }) => {
        ...
        await expect(page.locator('text=Pricing').or(page.getByTestId('text-pricing-title')).first()).toBeVisible();
    });
