...
test.describe('User Journey', () => {
    ...
    test('should load the home page successfully', async ({ page }) => {
        await page.goto('/');
        await expect(page).toHaveTitle("NEET 2026 Preparation — AI-Powered Learning Platform | ZERO AI");
    ...
    test('should navigate to pricing', async ({ page }) => {
        ...
        // Use test-id if present to guarantee finding the pricing page header
