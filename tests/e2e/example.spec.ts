...
test.describe('User Journey', () => {
    ...
    test('should load the home page successfully', async ({ page }) => {
        ...
        await expect(page.getByTestId('text-hero-headline').first()).toBeVisible();
    ...
    test('should navigate to pricing', async ({ page }) => {
        ...
        await expect(page.getByTestId('text-pricing-title').or(page.locator('h1, h2').filter({ hasText: /Pricing/i }))).toBeVisible();
    });
