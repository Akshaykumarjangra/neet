...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Intro Everyday Chemistry", "text": "From medicines to the food we eat, chemistry plays a vital role in our daily lives! This chapter explores how chemical principles improve our health, hygiene, and even our diet. Get ready to discover the science behind common products!"},
  {"title": "Drugs & Therapy", "text": "We'll start with therapeutic drugs, substances designed to treat diseases. A key concept here is 'selective toxicity,' meaning a drug targets disease-causing agents without harming the host. This precision is crucial for effective treatment."},
  {"title": "Antiseptics Disinfectants", "text": "Next, let's clarify two important cleansing agents: antiseptics and disinfectants! Antiseptics are applied to living tissues to kill or inhibit microorganisms, while disinfectants are stronger and used on inanimate objects. Understanding their difference is vital for proper application."},
  {"title": "Soaps Detergents", "text": "Ever wondered about the chemistry of cleaning? We'll dive into soaps versus detergents! Soaps are natural salts of fatty acids, effective in soft water, while synthetic detergents work well even in hard water due to their unique chemical structure."},
  {"title": "Food Sweeteners", "text": "Finally, we'll touch upon chemistry in food, specifically artificial sweeteners. These compounds provide sweetness without the calories, offering alternatives for health-conscious choices. Chemistry truly is everywhere, making life better in countless ways!"}
];
        let isPlaying = false;
