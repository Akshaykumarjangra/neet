...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Polymer Basics", "text": "Welcome to the fascinating world of Polymers! These are giant molecules, or macromolecules, built from many small, repeating units called monomers. Think of them as long chains made of identical beads!"},
  {"title": "Classifying Polymers", "text": "Polymers aren't all the same; we classify them based on their origin, structure, and behavior. A key distinction is between thermoplastics, which can be melted and reshaped, and thermosets, which are irreversibly hardened."},
  {"title": "Making Polymers", "text": "How do these chains form? It's through polymerization! We'll explore two main mechanisms: Addition polymerization, where monomers simply add to each other, and Condensation polymerization, which involves the elimination of a small molecule like water."},
  {"title": "Polymer Characteristics", "text": "The \"Degree of Polymerization\" tells us the number of monomer units in a chain, significantly impacting a polymer's strength and properties. Understanding this is crucial for tailoring materials for specific uses, from plastics to synthetic fibers."},
  {"title": "Polymers in Life", "text": "From everyday plastics to natural proteins, polymers are everywhere, revolutionizing industries and daily life. We'll also delve into biodegradable polymers, offering sustainable solutions for a greener future."}
];
        let isPlaying = false;
