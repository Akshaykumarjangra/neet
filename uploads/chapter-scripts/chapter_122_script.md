...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Intro Hormones", "text": "Welcome, future doctors, to the amazing world of Chemical Coordination and Integration! Ever wondered how your body manages growth, metabolism, and stress? It's all thanks to tiny chemical messengers called hormones, produced by your endocrine system."},
  {"title": "Master Regulators", "text": "At the core of this system is the Hypothalamus-Pituitary Axis, the master control center. The hypothalamus directs the pituitary, which then orchestrates other endocrine glands, ensuring a delicate balance through negative feedback."},
  {"title": "Thyroid's Role", "text": "Let's talk thyroid! This crucial gland produces T3 and T4, vital for metabolism, growth, and development, and requires iodine. It also secretes calcitonin, playing a key role in lowering blood calcium levels."},
  {"title": "Sugar Balance", "text": "Maintaining blood sugar is critical, and two pancreatic hormones are the stars: Insulin lowers glucose, while Glucagon raises it. Imbalances, like in diabetes, highlight the importance of this precise regulation."},
  {"title": "How Hormones Work", "text": "But how do hormones act? Steroid hormones directly enter cells to bind with nuclear receptors, while peptide hormones use surface receptors and second messengers like cAMP. Understanding these mechanisms is key to unlocking their power."}
];
        let isPlaying = false;
