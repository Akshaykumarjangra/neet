...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Health & Disease", "text": "Welcome to Human Health and Disease! Understanding pathogens, our immune system, and major illnesses like AIDS and cancer is crucial for NEET. Let's explore how our bodies fight back and how diseases spread."},
  {"title": "Pathogens & Malaria", "text": "Many diseases are caused by pathogens like Plasmodium, the parasite behind malaria. Its complex life cycle involves both humans and the female Anopheles mosquito, leading to recurrent fevers and chills."},
  {"title": "Immune Defenses", "text": "Our body's defense system has two main types: Innate immunity, our non-specific, birth-present barrier; and Acquired immunity, which develops after exposure, offering specific protection and memory against invaders."},
  {"title": "Antibodies & Cells", "text": "Key players in immunity are B-cells, which produce Y-shaped antibodies to target antigens, and T-cells, which directly destroy infected cells. These work together for a robust defense."},
  {"title": "Major Diseases", "text": "Finally, we'll delve into major health challenges like HIV, which attacks T-helper cells, and cancer, characterized by uncontrolled cell division and metastasis. Understanding these is vital for prevention and treatment."}
];
        let isPlaying = false;
