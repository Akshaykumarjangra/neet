...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Electric Current Basics", "text": "Welcome, future doctors! Today, we ignite our understanding of Current Electricity, a fundamental chapter for NEET success. We'll explore how charges flow, creating the electric current that powers our world."},
  {"title": "Ohm's Law Revealed", "text": "At the heart of current electricity lies Ohm's Law, linking voltage, current, and resistance in a simple yet powerful relationship. We'll also dive into resistivity, understanding how different materials conduct electricity uniquely."},
  {"title": "Drift Velocity Explained", "text": "Ever wondered how electrons actually move in a conductor? We'll uncover the concept of drift velocity, a surprisingly slow but crucial movement that constitutes the electric current."},
  {"title": "Circuit Laws", "text": "Mastering complex electrical circuits becomes easy with Kirchhoff's Laws – the junction rule and loop rule. We'll also quantify energy transfer by understanding electrical power in these circuits."},
  {"title": "Measuring Devices", "text": "Finally, we'll explore essential measuring instruments like the Wheatstone bridge for precise resistance measurements and the potentiometer for accurate voltage comparisons. These are vital tools for practical applications and NEET problems."}
];
        let isPlaying = false;
