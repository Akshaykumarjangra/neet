...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "What is Photosynthesis?", "text": "Photosynthesis is the incredible process where green plants, algae, and some bacteria convert light energy into chemical energy. It's the bedrock of life on Earth, providing the oxygen we breathe and the organic matter for all food chains."},
  {"title": "The Grand Equation", "text": "The balanced equation is 6CO₂ + 12H₂O + Light → C₆H₁₂O₆ + 6O₂ + 6H₂O. A key insight for NEET: the oxygen released comes from the splitting of water molecules, known as photolysis, not from carbon dioxide."},
  {"title": "Chloroplast: The Factory", "text": "This vital process takes place within the chloroplasts inside plant cells. Its internal structure features the stroma, where the dark reactions occur, and the thylakoids, which are the sites of the light-dependent reactions."},
  {"title": "Colorful Pigments", "text": "Photosynthesis is powered by photosynthetic pigments. Chlorophyll 'a' is the universal primary pigment, directly involved in trapping light energy, while carotenoids serve as important accessory pigments."},
  {"title": "Pigment Roles", "text": "Chlorophyll 'a' exists in specific forms like P680 and P700, optimized to absorb distinct light wavelengths. Carotenoids play a crucial protective role, shielding the plant from harmful photo-oxidation."}
];
        let isPlaying = false;
