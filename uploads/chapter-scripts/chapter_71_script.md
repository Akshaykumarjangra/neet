...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Transport Marvels", "text": "How does water defy gravity to reach a 100-meter tree's top? This chapter unravels the incredible transport systems in plants. We'll explore how water and minerals ascend, and how food travels throughout the plant body."},
  {"title": "Water Potential Basics", "text": "Water movement begins with water potential, the driving force where water flows from high to low potential. We'll also differentiate between the faster apoplast and controlled symplast pathways for absorption."},
  {"title": "Water's Upward Journey", "text": "The mighty transpiration pull, driven by evaporation from leaves, is the primary force for water ascent, explained by the cohesion-tension theory. We'll also cover root pressure, a vital force for short plants and guttation."},
  {"title": "Stomatal Regulation", "text": "Transpiration, the loss of water vapor from leaves, is largely controlled by stomata. Learn how guard cells regulate stomatal opening and closing, influencing not just water loss but also gas exchange."},
  {"title": "Food's Phloem Highway", "text": "Finally, discover phloem transport, where sugars move from source to sink via the pressure flow hypothesis. This vital system ensures that energy reaches every part of the plant, fueling growth and development."}
];
        let isPlaying = false;
