...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Animal Organisation", "text": "Welcome to Chapter 7! We're exploring how animal bodies are built, from tiny cells to complex organ systems. Get ready to understand the fundamental building blocks that keep animals alive and functioning."},
  {"title": "Four Tissue Types", "text": "All animal bodies are composed of just four main tissue types: Epithelial, Connective, Muscular, and Neural. Each tissue has a distinct structure and specialized function essential for survival."},
  {"title": "Epithelial, Connective", "text": "Epithelial tissue forms protective coverings and linings, classified by cell shape and layers. Connective tissue, like bone, blood, or fat, provides support, binds structures, and always consists of cells within a matrix."},
  {"title": "Muscular, Neural", "text": "Muscular tissue enables movement through its three types: skeletal, smooth, and cardiac. Neural tissue, with its neurons and glial cells, acts as the body's rapid communication network, coordinating all activities and responses."},
  {"title": "System Integration", "text": "These specialized tissues combine to form organs, which then integrate into complex organ systems like digestive or circulatory. This intricate organization ensures all bodily functions work together seamlessly for homeostasis and overall animal function."}
];
        let isPlaying = false;
