...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Classify Life!", "text": "Ever wondered how we organize Earth's millions of diverse species? Biological Classification helps us make sense of life's incredible variety, from microscopic bacteria to giant whales. This chapter delves into the scientific systems used to categorize living organisms."},
  {"title": "Whittaker's Kingdoms", "text": "We'll explore R.H. Whittaker's Five Kingdom Classification: Monera, Protista, Fungi, Plantae, and Animalia. This system groups organisms based on cell structure, body organization, mode of nutrition, and evolutionary relationships. Get ready to meet each kingdom!"},
  {"title": "Monera, Fungi", "text": "First up, Kingdom Monera, home to all prokaryotes like bacteria, lacking a true nucleus. Then, Kingdom Fungi, fascinating eukaryotic decomposers with chitin cell walls, forming intricate networks called mycelia. They play crucial roles in ecosystems!"},
  {"title": "Viruses, Viroids", "text": "Now, let's explore the enigmatic world of viruses, viroids, and prions – entities that blur the line between living and non-living. Viruses are non-cellular, parasitic particles, while viroids are just RNA, and prions are infectious proteins. They're incredibly simple yet potent!"},
  {"title": "Lichens, Protista", "text": "Finally, we'll uncover Lichens, amazing symbiotic partnerships between algae and fungi, acting as pollution indicators. And don't forget Kingdom Protista, the diverse unicellular eukaryotes, a crucial bridge between simpler and more complex life forms. Let's master these concepts for NEET!"}
];
        let isPlaying = false;
