...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "AC vs DC", "text": "Welcome to Alternating Current, where electricity constantly changes direction and magnitude! Unlike DC, AC varies sinusoidally with time, powering our homes and industries. This chapter explores the unique characteristics of AC voltage and current waveforms."},
  {"title": "RMS Values", "text": "Since AC fluctuates, how do we measure its effective strength? We use RMS or Root Mean Square values, which represent the equivalent DC current or voltage that would produce the same heating effect. This concept is crucial for practical AC calculations."},
  {"title": "Reactance Impedance", "text": "In AC circuits, capacitors and inductors don't just resist; they 'react'! Inductive and capacitive reactances are frequency-dependent oppositions to current flow. When combined with resistance, they form 'impedance,' the total effective opposition in an AC circuit."},
  {"title": "LCR Resonance", "text": "When resistors, inductors, and capacitors are combined, we form LCR circuits. A fascinating phenomenon called 'resonance' occurs at a specific frequency, where the inductive and capacitive reactances cancel out, leading to minimum impedance and maximum current."},
  {"title": "Power Transformers", "text": "Understanding the 'power factor' helps us calculate the true power consumed in AC circuits, considering the phase difference between voltage and current. We'll also explore 'transformers,' vital devices that efficiently step up or step down AC voltages for transmission and distribution."}
];
        let isPlaying = false;
