...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Atom's Universe", "text": "Ever wondered what makes up everything around you? It's atoms! Join us on an incredible journey deep inside these tiny building blocks to unravel their secrets and understand how they truly work."},
  {"title": "Inner Structure", "text": "Atoms aren't indivisible; they're made of subatomic particles! Discover the positively charged protons and neutral neutrons in the nucleus, with negatively charged electrons zipping around, as first revealed by Rutherford's nuclear model."},
  {"title": "Bohr's Levels", "text": "Rutherford's model had flaws. Niels Bohr proposed electrons orbit in fixed energy levels, like planetary paths, explaining atomic stability and discrete emission spectra. Electrons jump between these levels by absorbing or emitting precise energy packets."},
  {"title": "Quantum Leap", "text": "But reality is even stranger! The Quantum Mechanical Model shows electrons behaving as waves, not just particles. We can only predict probability regions called orbitals where electrons are most likely to be found."},
  {"title": "Electron's Address", "text": "To precisely describe each electron, we use four quantum numbers defining its energy, shape, and spatial orientation. Learn how electrons fill these orbitals following rules like Aufbau, Pauli, and Hund, determining an atom's unique electronic configuration."}
];
        let isPlaying = false;
