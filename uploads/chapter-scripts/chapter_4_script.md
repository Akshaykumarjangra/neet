...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plane Motion Intro", "text": "Ever wondered how a football flies or a boat crosses a river? Welcome to Motion in a Plane! We'll extend our 1D kinematics knowledge using powerful vector tools to describe movement in two dimensions."},
  {"title": "Projectile Flight", "text": "First up, let's master Projectile Motion! We'll break down the flight path, understand how to calculate the maximum height reached, and determine its horizontal range."},
  {"title": "Circular Paths", "text": "Next, we dive into the fascinating world of Circular Motion. Imagine a stone whirled on a string – we'll analyze uniform and non-uniform circular motion and its unique characteristics."},
  {"title": "Centripetal Force", "text": "A crucial concept here is Centripetal Acceleration, which always points towards the center of the circle, keeping the object on its curved path. We'll also define and calculate Angular Velocity, revealing how fast an angle changes."},
  {"title": "Relative Velocity", "text": "Finally, we'll touch upon relative velocity in 2D, a powerful tool for analyzing complex scenarios. Master these concepts, and you'll be well-prepared for any NEET challenge on Motion in a Plane!"}
];
        let isPlaying = false;
