...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Energy Everywhere", "text": "Ever wondered why some reactions release heat and others need it? Thermodynamics is the exciting branch of chemistry that unravels these energy transformations. It's all about heat, work, and predicting if a reaction will happen on its own!"},
  {"title": "System Basics", "text": "First, let's define our focus: the \"system\" is what we study, and \"surroundings\" is everything else. The First Law of Thermodynamics tells us energy is always conserved; it can only change forms, never created or destroyed!"},
  {"title": "Enthalpy Changes", "text": "When reactions happen at constant pressure, we talk about Enthalpy, or ΔH. Exothermic reactions release heat (negative ΔH), while endothermic ones absorb it (positive ΔH). Hess's Law helps us calculate overall ΔH by summing up individual reaction steps!"},
  {"title": "Disorder Rules", "text": "But energy isn't the only factor! Entropy, or ΔS, measures disorder or randomness in a system. The universe naturally tends towards increasing disorder, a fundamental principle influencing all processes."},
  {"title": "Reaction Spontaneity", "text": "Combining enthalpy and entropy, Gibbs Free Energy (ΔG) is our ultimate predictor for spontaneity. A negative ΔG means a reaction will happen on its own, while a positive ΔG tells us it's non-spontaneous. We can also calculate reaction ΔH using bond enthalpies!"}
];
        let isPlaying = false;
