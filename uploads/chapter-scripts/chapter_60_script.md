...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Coordination Magic", "text": "Coordination compounds are metal complexes that play vital roles in biology, industry, and medicine! From hemoglobin to anticancer drugs, this chapter explores their structure, naming, and bonding."},
  {"title": "Unveiling Structure", "text": "At their core, a central metal ion bonds to surrounding ligands, defining its coordination number. Werner's Theory explains metals have primary (oxidation state) and secondary (coordination number) valencies, with secondary valency being directional."},
  {"title": "Ligands & Names", "text": "Ligands can be monodentate, bidentate, or polydentate, with chelating ligands forming stable rings. We'll master IUPAC naming, arranging ligands alphabetically and indicating the metal's oxidation state."},
  {"title": "Isomer Puzzles", "text": "Coordination compounds exhibit fascinating isomerism, from structural types like ionization and linkage, to stereoisomers like geometrical and optical forms. Remember cis-platin, a famous anticancer drug, is a geometrical isomer!"},
  {"title": "CFT & Splitting", "text": "Crystal Field Theory explains how ligands split the d-orbital energies of the metal, influencing magnetic properties and color. The Spectrochemical Series ranks ligands by their splitting ability, differentiating strong and weak field ligands."}
];
        let isPlaying = false;
