...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "States of Matter", "text": "Why is ice solid, water liquid, and steam gas? This chapter unlocks the mysteries behind the different states of matter, exploring the forces that bind molecules and govern their behavior."},
  {"title": "Intermolecular Forces", "text": "The secret lies in intermolecular forces! We'll discover how dispersion, dipole-dipole, and powerful hydrogen bonding determine if a substance is solid, liquid, or gas at a given temperature."},
  {"title": "Gas Laws", "text": "For gases, specific rules apply! Learn Boyle's, Charles', Gay-Lussac's, and Avogadro's laws, which predict how pressure, volume, and temperature are interconnected under various conditions."},
  {"title": "Ideal & Real", "text": "Combine these laws into the powerful Ideal Gas Equation, PV=nRT. But remember, real gases have their quirks, deviating from ideal behavior due to molecular size and attractive forces, which the Van der Waals equation helps correct."},
  {"title": "Kinetic Theory", "text": "We'll dive into the Kinetic Molecular Theory, understanding gases as tiny, constantly moving particles whose average kinetic energy is proportional to temperature. Finally, explore critical constants, marking the fascinating boundary where liquid and gas phases blur."}
];
        let isPlaying = false;
