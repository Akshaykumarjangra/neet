...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Reaction Speed", "text": "Ever wondered why some reactions are super fast, while others, like rusting, take ages? Chemical Kinetics is your answer! It's the branch of chemistry that studies reaction rates and the factors influencing them, crucial for understanding how processes unfold."},
  {"title": "Rate Laws", "text": "How do we mathematically describe reaction speed? That's where Rate Laws come in! They express the rate in terms of reactant concentrations, helping us determine the reaction order and molecularity."},
  {"title": "First-Order Half-Life", "text": "For first-order reactions, a key concept is Half-Life – the time it takes for half of the reactant to disappear. It's constant for first-order reactions, making it super useful for understanding radioactive decay or drug elimination."},
  {"title": "Arrhenius Equation", "text": "Temperature is a game-changer for reaction rates! The Arrhenius Equation quantifies this relationship, showing how temperature and activation energy dictate how many molecules have enough energy to react."},
  {"title": "Catalysis Effect", "text": "Imagine speeding up a reaction without being consumed! That's catalysis – where catalysts provide an alternative reaction pathway with lower activation energy, making reactions happen much faster. It's vital for industrial processes and biological systems."}
];
        let isPlaying = false;
