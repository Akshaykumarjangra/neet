...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Excretion Unveiled", "text": "Ever wondered how your body gets rid of waste? Welcome to Chapter 19: Excretory Products and their Elimination! We'll explore the incredible human excretory system, centered around your kidneys – vital organs that keep your internal environment perfectly balanced."},
  {"title": "Nitrogenous Wastes", "text": "Animals eliminate different nitrogenous wastes based on water availability. Fish are ammonotelic, expelling toxic ammonia, while mammals are ureotelic, converting ammonia to less toxic urea. Birds and reptiles conserve water by forming uric acid, which requires minimal water for excretion."},
  {"title": "Nephron's Journey", "text": "Each kidney houses millions of tiny filtering units called nephrons. Urine formation happens in three steps: first, glomerular filtration forms a massive filtrate, then tubular reabsorption reclaims vital substances, and finally, tubular secretion adds unwanted materials to the forming urine."},
  {"title": "Fluid Balance", "text": "Your kidneys precisely regulate fluid balance. The countercurrent mechanism in the Loop of Henle and vasa recta creates a concentration gradient, allowing you to produce highly concentrated urine. Hormones like ADH and Aldosterone fine-tune this process, ensuring your body retains just the right amount of water and salts."},
  {"title": "Renal Solutions", "text": "When kidneys fail, metabolic wastes accumulate, leading to life-threatening conditions. Hemodialysis acts as an artificial kidney, filtering the blood externally to remove these harmful substances. This crucial procedure highlights the importance of maintaining a healthy excretory system."}
];
        let isPlaying = false;
