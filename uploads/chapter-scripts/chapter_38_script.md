...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Solid State Intro", "text": "Ever wondered why some materials are rigid and others flow? Welcome to the fascinating world of The Solid State, where particles are tightly packed in fixed positions, giving solids their unique shape and volume."},
  {"title": "Crystalline Amorphous", "text": "Not all solids are created equal! We'll explore the distinct differences between highly ordered crystalline solids and the randomly arranged amorphous solids, understanding their unique structures and properties."},
  {"title": "Unit Cells", "text": "The repeating pattern in crystalline solids is built from a fundamental unit called the unit cell. Imagine these tiny building blocks stacking up to form the entire crystal lattice, defining its overall structure."},
  {"title": "Packing Density", "text": "How efficiently do particles pack within these unit cells? We'll calculate packing efficiency, the density of crystals, and understand the crucial relationship between atomic radius and unit cell edge length, vital for material science."},
  {"title": "Defects Properties", "text": "Even perfect crystals can have tiny imperfections called defects, which profoundly impact their electrical and magnetic properties. From semiconductors to ferromagnets, these 'flaws' are often engineered for specific applications."}
];
        let isPlaying = false;
