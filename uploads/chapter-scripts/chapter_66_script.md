...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Kingdom Intro", "text": "Welcome, future doctors! Get ready to explore the incredible Plant Kingdom, a world of diversity from tiny mosses to giant trees. This chapter will take us on an evolutionary journey through the major plant groups."},
  {"title": "Algae & Bryophytes", "text": "We begin with Algae, classified by their pigments like green, brown, and red. Next, meet Bryophytes, the 'Amphibians of the Plant Kingdom,' non-vascular plants needing water for reproduction, with a dominant gametophyte stage."},
  {"title": "Pterido & Gymno", "text": "Evolving further, Pteridophytes are the first vascular plants with xylem and phloem, though they lack seeds. Then come Gymnosperms, the first seed plants, characterized by their 'naked seeds' and cone structures."},
  {"title": "Angiosperms Reign", "text": "Our journey culminates with Angiosperms, the dominant flowering plants whose seeds are enclosed within fruits. They represent the most diverse group, showcasing double fertilization and incredible adaptations."},
  {"title": "Life Cycles Evolve", "text": "Throughout this evolution, remember the crucial 'Alternation of Generations' – the shift between gametophyte and sporophyte dominance. Understanding these life cycles is key to mastering the Plant Kingdom's fascinating journey."}
];
        let isPlaying = false;
