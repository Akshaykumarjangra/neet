...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Heat's Secrets", "text": "Ever wondered why objects expand when heated or how a thermometer works? Welcome to Thermal Properties of Matter, where we unlock the secrets of heat and temperature's impact on everything around us!"},
  {"title": "Measuring Heat", "text": "Our journey begins with understanding how we measure 'hotness' or 'coldness' – temperature. We'll explore different temperature scales like Celsius, Fahrenheit, and Kelvin, and how to convert between them for NEET problems."},
  {"title": "Matter Expands", "text": "Next, discover the fascinating phenomenon of thermal expansion! Learn how solids, liquids, and gases change in size with temperature, and its practical applications and implications."},
  {"title": "Energy Transfer", "text": "Dive into calorimetry, the science of measuring heat transfer, and the crucial concept of specific heat capacity. We'll also explore latent heat, the hidden energy involved in phase changes like melting or boiling, without temperature change."},
  {"title": "Heat's Journey", "text": "Finally, let's explore how heat travels from one place to another. We'll demystify conduction, convection, and radiation – the three primary mechanisms of heat transfer, vital for understanding real-world scenarios."}
];
        let isPlaying = false;
