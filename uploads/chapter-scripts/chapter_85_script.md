...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Neural Basics", "text": "Ever wondered how your body coordinates everything, from thinking to blinking? It's all thanks to your incredible nervous system! At its core are neurons, specialized cells with dendrites, a cell body, and an axon, designed to transmit signals at lightning speed."},
  {"title": "Nerve Impulse", "text": "How do neurons send messages? Through an 'Action Potential'! This rapid electrical signal involves precise ion movements—sodium in, then potassium out—creating a temporary voltage change across the membrane, an all-or-none event."},
  {"title": "Synaptic Talk", "text": "Neurons don't touch; they communicate across tiny gaps called synapses. When an impulse arrives, neurotransmitters are released, binding to receptors on the next neuron to continue the signal journey."},
  {"title": "Brain Power", "text": "Your brain, the command center, is divided into the forebrain, midbrain, and hindbrain, each with vital roles. The cerebrum, with its distinct lobes like frontal for motor control and occipital for vision, handles higher functions."},
  {"title": "Reflex Actions", "text": "For quick, involuntary responses, your body uses a 'Reflex Arc'. This rapid pathway involves a sensory neuron, the spinal cord, and a motor neuron, allowing you to react instantly without conscious brain processing."}
];
        let isPlaying = false;
