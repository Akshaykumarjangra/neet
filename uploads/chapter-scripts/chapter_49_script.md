...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Carbonyl Basics", "text": "Welcome, future doctors! Today, we unlock the world of carbonyl compounds: aldehydes, ketones, and carboxylic acids. These fascinating molecules, defined by their C=O group, are everywhere – from fragrances to pharmaceuticals."},
  {"title": "Synthesis Routes", "text": "How do we make them? We'll explore diverse preparation methods, including oxidation of alcohols, ozonolysis of alkenes, and Friedel-Crafts acylation. Mastering these routes is crucial for your NEET success!"},
  {"title": "Reaction Powerhouse", "text": "Get ready for reaction mechanisms! Aldehydes and ketones are highly reactive, undergoing nucleophilic addition and key named reactions like Aldol Condensation. Understand why their carbonyl carbon is so electrophilic."},
  {"title": "Carboxylic Acids", "text": "Next, we dive into carboxylic acids. Learn their unique preparation methods and, most importantly, the factors influencing their acidity. We'll compare their acidic strength with other organic compounds."},
  {"title": "Master Concepts", "text": "By the end, you'll master carbonyl reactivity, predict reaction outcomes, and compare acid strengths. This chapter is a high-yield topic for NEET, so let's ace it together!"}
];
        let isPlaying = false;
