...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Enhance Food", "text": "With a rapidly growing global population, ensuring adequate and nutritious food is a monumental challenge. This chapter explores key strategies like plant breeding, animal husbandry, and modern biotechnologies to enhance food production."},
  {"title": "Plant Breeding", "text": "Plant breeding involves purposeful manipulation of plant species to create desired plant types. We'll delve into the systematic pipeline, from germplasm collection to selection, aiming for high-yield and disease-resistant varieties."},
  {"title": "Biofortification Boost", "text": "Beyond just quantity, quality matters! Biofortification is the process of breeding crops with higher levels of vitamins, minerals, or proteins. It's a vital step in combating malnutrition and improving public health."},
  {"title": "Animal Husbandry", "text": "Animal husbandry focuses on the scientific management of livestock for various benefits like milk, meat, eggs, and wool. We'll explore practices such as dairy farming, poultry farming, and fisheries that boost animal-derived food sources."},
  {"title": "Single Cell", "text": "Looking ahead, modern biotechnologies offer revolutionary solutions. Single Cell Protein (SCP) uses microorganisms to produce protein-rich biomass, providing an eco-friendly and efficient alternative food source for humans and animals."}
];
        let isPlaying = false;
