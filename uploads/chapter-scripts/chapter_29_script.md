...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Welcome Electronics", "text": "Ever wondered what powers your smartphone or computer? It's the magic of semiconductors! This chapter bridges physics to modern electronics, exploring the materials and devices that revolutionized our world."},
  {"title": "Energy Bands", "text": "At the heart of semiconductors lies the concept of energy bands – valence and conduction bands, separated by a crucial band gap. We'll differentiate between intrinsic, pure semiconductors, and extrinsic types like N-type and P-type, doped for specific properties."},
  {"title": "P-N Junctions", "text": "Combining P-type and N-type materials creates a P-N junction, the fundamental building block of many devices. This junction forms a diode, a one-way street for current, essential for rectification – converting AC to DC, and we'll even touch upon the Diode Equation."},
  {"title": "Transistors Amplifiers", "text": "Moving beyond diodes, transistors are three-terminal marvels capable of amplification and switching. We'll explore their various configurations, understanding concepts like Transistor Current Gain and the crucial Current Relations that govern their operation."},
  {"title": "Logic Gates", "text": "Finally, we'll dive into the digital realm with logic gates – the decision-makers of electronics, forming the basis of all digital circuits. Discover how these gates combine to create complex Integrated Circuits (ICs), powering everything from calculators to supercomputers."}
];
        let isPlaying = false;
