...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Dual Nature Unveiled", "text": "Welcome, future doctors, to Chapter 11: Dual Nature of Radiation and Matter! Prepare to challenge classical physics as we explore how light behaves both as a wave and a particle. This chapter lays the foundation for understanding the quantum world and its mind-bending realities."},
  {"title": "Light's Particle Nature", "text": "Our journey begins with the revolutionary Photoelectric Effect, where light ejects electrons from a metal surface. This phenomenon couldn't be explained by the wave theory, leading to the idea that light consists of discrete energy packets called photons."},
  {"title": "Einstein's Equation", "text": "Einstein's photoelectric equation, hf = Φ + Kmax, beautifully explains this effect. Here, photon energy (hf) is used to overcome the work function (Φ) and provide kinetic energy to the emitted electrons. Understanding threshold frequency and stopping potential is key here."},
  {"title": "Matter Waves", "text": "But wait, it gets even crazier! De Broglie proposed that matter, like electrons, also exhibits wave-like properties. Every moving particle has an associated wavelength, given by λ = h/p, connecting momentum to wave nature."},
  {"title": "Quantum Insights", "text": "This dual nature concept profoundly changed our understanding of the universe, bridging the gap between classical and quantum mechanics. Master these concepts to ace NEET and grasp the fundamental principles governing the smallest particles."}
];
        let isPlaying = false;
