...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Intro Circulation", "text": "Ever wondered how nutrients reach every cell or how waste leaves? It's all thanks to your body fluids and an incredible circulatory system! Today, we'll explore the life-sustaining journey of blood and the amazing heart."},
  {"title": "Blood Components", "text": "Your blood is a vital fluid, composed of about 55% plasma—water, proteins, and nutrients—and 45% formed elements. These include RBCs for oxygen, WBCs for defense, and platelets for clotting."},
  {"title": "Heart's Chambers", "text": "At the core of circulation is your four-chambered heart: two atria receive blood, and two ventricles pump it out. Remember, the right side handles deoxygenated blood, while the left side manages oxygenated blood."},
  {"title": "Heartbeat Rhythm", "text": "Each heartbeat is a precise 0.8-second dance, called the Cardiac Cycle. It starts with atrial systole, followed by ventricular systole, and finally, a joint diastole where the heart rests and refills."},
  {"title": "Double Circuit", "text": "Your body features a sophisticated 'double circulation' system. Blood travels from the heart to the lungs and back (pulmonary circuit), and then from the heart to the rest of the body and back (systemic circuit), ensuring efficient transport."}
];
        let isPlaying = false;
