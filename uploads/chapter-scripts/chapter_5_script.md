...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Motion's Foundation", "text": "Ever wondered why things move or stop? Today, we unlock the secrets of motion with Newton's Laws, the bedrock of classical mechanics. Get ready to understand the fundamental forces shaping our world!"},
  {"title": "Newton's First", "text": "First up, Newton's First Law: the Law of Inertia. An object at rest stays at rest, and an object in motion stays in motion unless acted upon by an external force. Think about why your body lurches forward when a car suddenly brakes!"},
  {"title": "Force & Momentum", "text": "Next, Newton's Second Law quantifies force! It states that the acceleration of an object is directly proportional to the net force and inversely proportional to its mass, famously expressed as F=ma. This law also introduces momentum, linking force to the change in motion."},
  {"title": "Action-Reaction", "text": "Then comes Newton's Third Law: for every action, there is an equal and opposite reaction. This means forces always come in pairs, acting on different objects. Imagine a rocket launching or simply pushing against a wall – understanding this explains so much!"},
  {"title": "Real-World Forces", "text": "Beyond the laws, we'll explore fascinating applications like friction, the force that opposes motion, and impulse, which relates force to the time it acts. These principles are fundamental to everything from walking to designing machines, making them vital for NEET!"}
];
        let isPlaying = false;
