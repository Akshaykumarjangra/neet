...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Chemistry Foundations", "text": "Welcome, future doctors, to the exciting world of Chemistry! This chapter introduces fundamental concepts, starting with matter – anything with mass and volume – and its classification into pure substances and mixtures."},
  {"title": "Atoms, Moles", "text": "Next, we bridge the microscopic world of atoms and molecules to the macroscopic with the 'mole concept.' A mole represents Avogadro's number of particles, a critical tool for quantitative chemistry."},
  {"title": "Masses, Stoichiometry", "text": "Grasp atomic and molecular masses, then link them to molar mass in grams. This understanding is vital for stoichiometry, the study of quantitative relationships in chemical reactions using balanced equations."},
  {"title": "Limiting Reactants", "text": "In many reactions, one reactant gets completely consumed first – this is your limiting reagent! It dictates the maximum amount of product that can be formed, a key concept for practical chemistry."},
  {"title": "Solutions, Formulas", "text": "Finally, master various concentration terms like Molarity and Molality to express solution strengths. We'll also learn to determine empirical and molecular formulas from elemental composition."}
];
        let isPlaying = false;
