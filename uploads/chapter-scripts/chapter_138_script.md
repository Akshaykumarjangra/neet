...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Environmental Challenges", "text": "Hey NEET aspirants! Today, we're tackling Chapter 16: Environmental Issues. We'll explore critical global problems like pollution, climate change, and the urgent need for sustainable practices to protect our planet."},
  {"title": "Polluted Air", "text": "First up, air pollution! Learn about harmful gases, particulate matter, and their sources, from industrial emissions to vehicular exhaust. Understand how these pollutants severely impact respiratory health and the ecosystem."},
  {"title": "Contaminated Water", "text": "Next, let's dive into water pollution. We'll examine how industrial waste, sewage, and agricultural runoff contaminate our precious water bodies. Discover the devastating effects on aquatic life and human health, including various waterborne diseases."},
  {"title": "Warming Planet", "text": "Now, let's understand global warming, driven by greenhouse gas emissions. Explore its causes, like deforestation and fossil fuel burning, and the alarming consequences, such as rising sea levels and extreme weather events."},
  {"title": "Ozone Layer", "text": "Finally, we'll discuss ozone depletion, a critical thinning of Earth's protective shield. Learn about CFCs and other ozone-depleting substances, and the increased UV radiation reaching us, posing severe health risks."}
];
        let isPlaying = false;
