...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Metal Extraction Basics", "text": "Welcome to the fascinating world of Metallurgy! This chapter explores the science and art of extracting metals from their natural ores, crucial for nearly every industry around us. We'll uncover the general principles and processes behind obtaining pure elements."},
  {"title": "Ore Concentration Steps", "text": "Before extracting metals, we first concentrate the ore by removing unwanted impurities called gangue. Methods like hydraulic washing, magnetic separation, froth flotation, and leaching prepare the ore for subsequent chemical transformations."},
  {"title": "Roasting Calcination", "text": "Next, thermal treatments like Roasting and Calcination transform the concentrated ore. Roasting heats sulfide ores in air to form oxides, while Calcination heats carbonate or hydroxide ores in limited air to remove volatile substances."},
  {"title": "Metal Reduction Methods", "text": "After thermal treatment, the metal oxides are reduced to crude metals using reducing agents like carbon or carbon monoxide. The Ellingham Diagram is a key tool here, helping us predict the thermodynamic feasibility of these reduction reactions at various temperatures."},
  {"title": "Pure Metal Refining", "text": "Finally, crude metals undergo refining to achieve high purity for industrial applications. Techniques include distillation, liquation, electrolytic refining, and zone refining, with electrolytic refining being a vital process for many common metals."}
];
        let isPlaying = false;
