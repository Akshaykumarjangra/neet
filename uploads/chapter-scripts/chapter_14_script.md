...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Rhythmic Motion", "text": "Ever noticed things repeating their movement perfectly? That's the essence of oscillations! We'll explore periodic motion, where objects like a swinging pendulum move back and forth over the same path, creating a beautiful rhythm."},
  {"title": "SHM Unveiled", "text": "The star of our show is Simple Harmonic Motion, or SHM. It's a special type of oscillation defined by a restoring force directly proportional to displacement, always pulling the object back towards its equilibrium position."},
  {"title": "Classic Examples", "text": "Let's see SHM in action! We'll analyze the spring-mass system, where a block oscillates attached to a spring, and the iconic simple pendulum, swinging gracefully under gravity's influence. These are fundamental models for understanding SHM."},
  {"title": "Energy Play", "text": "In SHM, energy is constantly transforming between kinetic and potential forms. We'll explore how total mechanical energy remains conserved, oscillating between maximum kinetic at equilibrium and maximum potential at the extreme positions."},
  {"title": "Resonance Power", "text": "Finally, prepare to be amazed by resonance! This powerful phenomenon occurs when an external driving force matches an object's natural frequency, leading to dramatically increased oscillation amplitudes. Think of pushing a swing at just the right time!"}
];
        let isPlaying = false;
