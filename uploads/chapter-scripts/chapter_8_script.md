...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Gravitation Unveiled", "text": "Welcome to Chapter 8: Gravitation! We're diving into one of the universe's fundamental forces, responsible for everything from apples falling to planets orbiting. This chapter is crucial for understanding the cosmos and scores high in NEET!"},
  {"title": "Universal Law", "text": "At its heart is Newton's Law of Universal Gravitation, stating that every particle attracts every other particle with a force directly proportional to the product of their masses and inversely proportional to the square of the distance between their centers. This fundamental law governs interactions across vast cosmic scales."},
  {"title": "Field & Energy", "text": "Beyond just force, we'll explore the concept of a Gravitational Field, the region around a mass where another mass experiences a force. We'll also unpack Gravitational Potential Energy, which is the energy an object possesses due to its position in a gravitational field."},
  {"title": "Orbital Dynamics", "text": "Ever wondered how satellites stay in orbit or why planets don't crash into the sun? This scene explains Orbital Motion, delving into the mechanics of satellites and celestial bodies revolving around a central mass. We'll explore orbital velocity and period."},
  {"title": "Escape Velocity", "text": "Finally, we tackle Escape Velocity – the minimum speed an object needs to break free from a planet's gravitational pull and never return. Mastering these concepts will equip you to solve complex problems and ace your NEET exam!"}
];
        let isPlaying = false;
