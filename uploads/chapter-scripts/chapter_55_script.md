...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Hydrogen's Story", "text": "Meet Hydrogen, the universe's simplest and most abundant element! We'll explore its unique position in the periodic table, bridging properties of both alkali metals and halogens."},
  {"title": "Hydrogen Isotopes", "text": "Discover hydrogen's three siblings: Protium, Deuterium, and radioactive Tritium. Learn about their different masses and how Deuterium plays a role in heavy water."},
  {"title": "Preparing Hydrogen", "text": "How do we get hydrogen? We'll look at laboratory methods like reacting metals with acids, and large-scale industrial processes such as steam reforming of methane and electrolysis."},
  {"title": "Types of Hydrides", "text": "Hydrogen forms various compounds called hydrides. We'll differentiate between ionic hydrides with s-block metals, covalent hydrides with non-metals, and metallic hydrides found with d-block elements."},
  {"title": "Water & H₂O₂", "text": "Dive into the unique properties of water, driven by strong hydrogen bonding, and explore hydrogen peroxide's 'open book' structure and its powerful oxidizing and reducing nature."}
];
        let isPlaying = false;
