...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "p-Block Unveiled", "text": "Welcome, future doctors! The p-block elements are a treasure trove of diversity, from metals to non-metals. Today, we dive into Groups 13 and 14: the Boron and Carbon families, crucial for NEET."},
  {"title": "Boron Family", "text": "Meet Group 13: Boron, Aluminum, Gallium, Indium, Thallium. With ns²np¹ configuration, they typically show a +3 oxidation state. Remember, Boron stands out as the only non-metal metalloid!"},
  {"title": "Carbon Family", "text": "Next, Group 14: Carbon, Silicon, Germanium, Tin, and Lead. Their ns²np² configuration leads to common +4 and sometimes +2 oxidation states, especially for heavier elements due to the inert pair effect."},
  {"title": "Electron Deficient", "text": "Boron's compounds, like BF₃ or B₂H₆, are electron deficient, forming unique 'banana bonds' in diborane. Also, don't forget Aluminum's amphoteric nature, reacting with both acids and bases!"},
  {"title": "Allotropes & Silicates", "text": "Carbon's versatility shines through its allotropes: diamond, graphite, fullerenes, and graphene. And from Silicon, we get essential silicates forming rocks, and synthetic silicones with their unique Si-O backbone."}
];
        let isPlaying = false;
