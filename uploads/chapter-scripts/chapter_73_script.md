...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Heredity Unveiled", "text": "Ever wondered why you share traits with your parents but aren't their exact replica? This chapter, \"Principles of Inheritance and Variation,\" unravels these fascinating mysteries. We'll explore how characteristics are passed down, leading to both similarities and unique differences!"},
  {"title": "Mendel's Legacy", "text": "Our journey begins with Gregor Mendel, the father of genetics, and his groundbreaking pea plant experiments. We'll delve into his three fundamental laws: Dominance, Segregation, and Independent Assortment, which form the bedrock of heredity."},
  {"title": "Predicting Traits", "text": "Learn to predict inheritance patterns using Punnett squares for monohybrid and dihybrid crosses. Understand the classic F₂ ratios, like 3:1 for a single trait and 9:3:3:1 for two, demonstrating how traits combine."},
  {"title": "Beyond Dominance", "text": "Not all inheritance follows simple dominant-recessive patterns! We'll explore incomplete dominance, where heterozygotes show an intermediate phenotype, and co-dominance, where both alleles are fully expressed simultaneously."},
  {"title": "Advanced Genetics", "text": "Finally, we'll tackle more complex scenarios like sex determination in humans and birds, and the unique patterns of sex-linked inheritance. Discover linkage and recombination, revealing how genes located on the same chromosome are passed together."}
];
        let isPlaying = false;
