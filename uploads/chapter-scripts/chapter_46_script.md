...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Why Purify?", "text": "Before we can truly understand any organic compound, we must first purify it and confirm its identity. This chapter equips you with essential lab techniques to separate, clean, and characterize organic compounds for NEET."},
  {"title": "Solid Purification", "text": "For solids, we'll master techniques like Sublimation, ideal for compounds that directly vaporize, leaving impurities behind. Crystallization, the most common method, leverages solubility differences to yield pure crystals."},
  {"title": "Liquid Distillation", "text": "Liquids are often purified by Distillation, with types like Simple for large boiling point differences, Fractional for close ones, and Steam for immiscible, high-boiling compounds. We'll also cover Vacuum distillation for heat-sensitive compounds."},
  {"title": "Chromatography & Tests", "text": "Dive into Chromatography, a powerful separation technique based on differential adsorption, including Column, TLC, and Paper. Then, learn Lassaigne's Test to qualitatively detect elements like N, S, and halogens in your compound."},
  {"title": "Characterization Tools", "text": "Finally, we characterize compounds using Quantitative Analysis to determine elemental composition. For deeper insights, Spectroscopy, including MS, IR, and NMR, provides unique structural information, making identification precise and complete."}
];
        let isPlaying = false;
