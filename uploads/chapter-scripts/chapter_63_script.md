...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Periodic Table Magic", "text": "Welcome, future doctors! Ever wondered how chemists make sense of over 100 elements? The periodic table is our ultimate map, organizing elements based on their properties and revealing hidden patterns."},
  {"title": "Modern Law Revealed", "text": "The modern periodic table isn't just a random grid; it's built on the Modern Periodic Law. Elements are arranged by increasing atomic number, which directly dictates their electronic configuration and chemical behavior."},
  {"title": "Atomic Size Secrets", "text": "One crucial property we can predict is atomic size. Learn how atomic radius changes across periods and down groups, influenced by factors like nuclear charge and electron shells. Understanding this trend is key to many chemical reactions."},
  {"title": "Ionization Energy", "text": "Next, let's unlock the secrets of Ionization Energy, the energy required to remove an electron from an atom. Discover its fascinating trends across the periodic table, explaining why some elements readily form positive ions."},
  {"title": "Electronegativity Predict", "text": "Finally, we'll explore Electronegativity, the power of an atom to attract shared electrons in a bond. Master this trend to predict bond types and molecular polarity, giving you incredible predictive power over chemical behavior!"}
];
        let isPlaying = false;
