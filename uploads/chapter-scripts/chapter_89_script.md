...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Invisible Allies", "text": "Welcome to 'Microbes in Human Welfare'! Often unseen, these tiny organisms are our powerful allies, revolutionizing everything from food to medicine and agriculture. Let's uncover how these microscopic heroes make our lives better."},
  {"title": "Food & Fermentation", "text": "From turning milk into delicious curd with Lactobacillus, to making bread rise and brewing beverages with yeast, microbes are fermentation masters! They also produce vital industrial products like organic acids and enzymes."},
  {"title": "Health & Sanitation", "text": "Discover the wonder of antibiotics, like Penicillin, battling bacterial infections. Microbes are also crucial in sewage treatment, where they biologically break down waste and reduce pollution, safeguarding our environment."},
  {"title": "Energy & Agriculture", "text": "Methanogens produce biogas, a sustainable energy source from organic waste, especially cow dung. In agriculture, biofertilizers like Rhizobium and Mycorrhiza enrich soil fertility naturally, boosting crop growth."},
  {"title": "Eco-Friendly Solutions", "text": "Finally, microbes act as biocontrol agents, offering eco-friendly pest management. From Bt bacteria to Trichoderma, they provide sustainable solutions, proving that even the smallest organisms can have the biggest impact on human welfare!"}
];
        let isPlaying = false;
