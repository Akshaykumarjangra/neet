...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Food's Amazing Journey", "text": "Ever wondered how your body turns that delicious food into energy? Welcome to Digestion and Absorption, where we'll unravel the incredible process from your first bite to nutrient delivery! Get ready to explore the fascinating world inside your gut."},
  {"title": "Alimentary Canal Tour", "text": "Our journey begins with the Alimentary Canal, a complete digestive tract from mouth to anus. We'll trace food's path through organs like the esophagus, stomach, and intestines, each playing a vital role in mechanical and initial chemical breakdown."},
  {"title": "Enzymes & Bile", "text": "But it's not just about organs; tiny powerhouses called enzymes do the real work! Learn about salivary amylase, pepsin, trypsin, and the crucial role of bile in breaking down complex food molecules into absorbable forms, preparing them for the next stage."},
  {"title": "Absorption Hub", "text": "The small intestine is our absorption superstar, with its incredible length, folds, and villi maximizing surface area. Discover how this organ efficiently extracts nutrients, making it the primary site for nutrient uptake into your body."},
  {"title": "Pathways to Cells", "text": "Finally, we'll track how absorbed nutrients reach every cell! Understand the distinct pathways for water-soluble nutrients via blood and fat-soluble ones via lymph, and how digestive hormones orchestrate this complex, life-sustaining process."}
];
        let isPlaying = false;
