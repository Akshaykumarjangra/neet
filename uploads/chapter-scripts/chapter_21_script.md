...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "EMI & Flux", "text": "Ever wondered how electricity is generated? It all starts with Electromagnetic Induction – the phenomenon where a changing magnetic field creates an electric current. At its heart is magnetic flux, a measure of the total magnetic field passing through a given area."},
  {"title": "Faraday's Laws", "text": "Faraday's Laws are the cornerstone, stating that the magnitude of induced EMF is proportional to the rate of change of magnetic flux. And Lenz's Law? It tells us the induced current always opposes the change in magnetic flux that produced it, ensuring energy conservation."},
  {"title": "Motional EMF", "text": "Imagine a conductor moving through a magnetic field. This relative motion itself induces an electromotive force, known as motional EMF. It's crucial for understanding how generators work, converting mechanical energy into electrical energy."},
  {"title": "Inductance, Energy", "text": "Inductance is a circuit's property to oppose changes in current, acting like electrical inertia. An inductor can store energy in its magnetic field, a concept vital for understanding many electronic components and their behavior."},
  {"title": "Real-World Power", "text": "From power generators illuminating our homes to transformers stepping up or down voltage for efficient transmission, electromagnetic induction is everywhere. Mastering these principles is key to acing NEET and understanding our electrified world."}
];
        let isPlaying = false;
