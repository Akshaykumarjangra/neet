...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Cell Basics", "text": "Welcome to 'Cell: The Unit of Life'! Every living organism, from the smallest bacteria to the largest whale, is fundamentally built from cells. This chapter will unlock the secrets of these incredible microscopic factories, exploring their structure and functions."},
  {"title": "Cell Foundations", "text": "We begin with the Cell Theory: all organisms are made of cells, cells are the basic unit of life, and new cells arise from pre-existing ones. Discover the fundamental differences between simple prokaryotic cells, lacking a true nucleus, and complex eukaryotic cells with their membrane-bound organelles."},
  {"title": "Cell Boundaries", "text": "The cell membrane, described by the Fluid Mosaic Model, is a selectively permeable lipid bilayer controlling what enters and exits the cell. Inside, the nucleus acts as the cell's control center, housing DNA within its nuclear envelope, nucleoplasm, chromatin, and nucleolus."},
  {"title": "Energy Factories", "text": "Meet the powerhouses! Mitochondria generate ATP through cellular respiration, featuring a double membrane with cristae and even their own DNA. In plant cells, chloroplasts capture sunlight for photosynthesis, containing grana and stroma, also possessing their unique genetic material."},
  {"title": "Cellular Systems", "text": "Finally, we explore the endomembrane system: a coordinated network including the Endoplasmic Reticulum, Golgi apparatus, lysosomes, and vacuoles. Together, these organelles are vital for protein synthesis, modification, packaging, and transport within the cell, ensuring its seamless operation."}
];
        let isPlaying = false;
