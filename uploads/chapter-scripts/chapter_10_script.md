...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Fluid World", "text": "Ever wondered why ships float or how blood flows through your veins? Welcome to \"Mechanical Properties of Fluids,\" where we unravel the fascinating behavior of liquids and gases. We'll explore everything from fluids at rest to their dynamic motion."},
  {"title": "Fluid Pressure", "text": "First, let's understand hydrostatic pressure, the force exerted by fluids at rest. We'll dive into how pressure varies with depth and density, and its crucial applications in everyday life."},
  {"title": "Buoyancy Explained", "text": "Next up is buoyancy, the upward force that makes objects float or sink. We'll explore Archimedes' principle to understand why some objects displace more fluid and experience greater buoyant force."},
  {"title": "Fluid Dynamics", "text": "Now, let's get fluids moving! We'll discover the equation of continuity, explaining how fluid speed changes with area, and Bernoulli's principle, linking pressure, speed, and height in an ideal fluid flow."},
  {"title": "Viscosity Insights", "text": "Finally, we'll examine viscosity, the internal friction within real fluids. This property explains why honey flows slower than water and is vital for understanding practical fluid applications."}
];
        let isPlaying = false;
