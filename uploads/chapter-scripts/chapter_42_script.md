...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Surface Chemistry Intro", "text": "Welcome to Surface Chemistry, a fascinating realm where interactions at interfaces govern properties! We'll explore adsorption, catalysis, and colloids, understanding how molecules behave at surfaces."},
  {"title": "Adsorption Unveiled", "text": "Adsorption is the accumulation of molecular species on the surface rather than in the bulk. We'll differentiate it from absorption and learn about adsorbates and adsorbents, noting how surface area impacts this crucial process."},
  {"title": "Isotherms Explained", "text": "Delve into adsorption isotherms, graphical representations showing the extent of adsorption at constant temperature. We'll specifically unravel the principles behind Freundlich and Langmuir isotherms, key models describing this phenomenon."},
  {"title": "Colloids Revealed", "text": "Next, we explore colloids – heterogeneous mixtures where particles are larger than molecules but small enough not to settle. Discover their unique characteristics and classifications, which set them apart from true solutions and suspensions."},
  {"title": "Tyndall Effect", "text": "Finally, witness the captivating Tyndall Effect, the scattering of light by colloidal particles. This phenomenon is crucial for distinguishing colloidal solutions from true solutions, offering a visible proof of their distinct nature."}
];
        let isPlaying = false;
