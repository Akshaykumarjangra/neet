...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Redox Everywhere", "text": "Ever wondered why iron rusts, or how batteries power your phone? The secret lies in Redox Reactions! These fundamental chemical processes involve the transfer of electrons, crucial for life and and countless technologies."},
  {"title": "Electron Dance", "text": "At its core, redox is an electron dance! Oxidation means losing electrons, causing an increase in oxidation number. Conversely, reduction means gaining electrons, leading to a decrease in oxidation number."},
  {"title": "Tracking Electrons", "text": "We track electron movement using oxidation numbers, assigned by specific rules. An oxidizing agent accepts electrons and gets reduced, while a reducing agent donates electrons and gets oxidized."},
  {"title": "Redox Varieties", "text": "Redox reactions come in many forms, including combination, decomposition, and displacement reactions. Don't forget disproportionation, where the same element is both oxidized and reduced!"},
  {"title": "Balancing Power", "text": "Mastering the half-reaction method helps balance even complex redox equations. Understanding redox is key to electrochemistry, explaining everything from corrosion to the electrochemical series."}
];
        let isPlaying = false;
