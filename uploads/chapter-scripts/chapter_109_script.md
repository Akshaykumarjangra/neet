...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Power", "text": "Welcome to Mineral Nutrition! Plants, unlike us, synthesize all their organic compounds from simple inorganic nutrients. They absorb these vital minerals from the soil as ions, fueling their growth, development, and every metabolic activity."},
  {"title": "Essential Elements", "text": "But what makes a nutrient 'essential'? Arnon and Stout gave us three strict criteria: it must be indispensable for life completion, specific in its role, and directly involved in plant metabolism. Without it, the plant simply cannot thrive."},
  {"title": "Macro vs Micro", "text": "We categorize essential elements based on quantity needed. Macronutrients, like Nitrogen, are required in large amounts, more than 10 mmol/kg of dry matter. Micronutrients, however, are vital in much smaller, trace quantities."},
  {"title": "Nitrogen's Niche", "text": "Let's dive into some key macronutrients, starting with Nitrogen. It's a superstar, forming the backbone of amino acids, proteins, nucleic acids like DNA and RNA, and even chlorophyll, the pigment crucial for photosynthesis."},
  {"title": "P & K Power", "text": "Next, Phosphorus is the energy currency, essential for ATP, NADP, nucleic acids, and phospholipids. And Potassium? It's an incredible enzyme activator for over 60 enzymes and critical for regulating stomatal movement, controlling water loss!"}
];
        let isPlaying = false;
