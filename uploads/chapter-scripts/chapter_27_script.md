...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Atomic Evolution", "text": "Ever wondered what atoms are truly made of? We'll journey from early models like Thomson's and Rutherford's, which laid the groundwork, to the revolutionary insights that changed our understanding of the atom."},
  {"title": "Bohr's Revolution", "text": "Enter Niels Bohr! His groundbreaking model for the hydrogen atom introduced the idea of stable electron orbits and quantized angular momentum, solving many puzzles of atomic stability."},
  {"title": "Quantized Energy", "text": "Bohr's model beautifully explained that electrons can only exist in specific, discrete energy levels and fixed orbit radii. This quantization means energy can only change in definite steps, not continuously."},
  {"title": "Atomic Fingerprint", "text": "When electrons jump between these quantized energy levels, they absorb or emit photons, creating unique atomic spectra. These distinct spectral lines act like a unique fingerprint for each element."},
  {"title": "Spectral Predictor", "text": "The Rydberg formula allows us to precisely calculate the wavelengths of these spectral lines, grouping them into series like Lyman, Balmer, and Paschen. Mastering this is key for NEET success!"}
];
        let isPlaying = false;
