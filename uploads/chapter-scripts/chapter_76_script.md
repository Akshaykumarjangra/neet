...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Ecosystem Basics", "text": "Welcome to Chapter 5: Ecosystem! Imagine nature's own economy, where everything is interconnected. Here, we'll explore how living organisms interact with their non-living environment, forming fascinating structures like producers, consumers, and decomposers."},
  {"title": "Energy Flow", "text": "The heart of any ecosystem is energy flow. Learn about Gross Primary Productivity (GPP) and Net Primary Productivity (NPP) – how much energy is captured and available. Remember the 10% Law: only a tiny fraction of energy transfers to the next trophic level!"},
  {"title": "Food Webs", "text": "How do organisms get their energy? Through intricate feeding relationships! We'll differentiate between simple, linear food chains and complex, realistic food webs, understanding how trophic levels define an organism's position."},
  {"title": "Ecological Pyramids", "text": "Visualize ecosystem structure with ecological pyramids! Discover pyramids of numbers and biomass, which can sometimes be inverted. Critically, the energy pyramid is *always* upright, reflecting the fundamental 10% energy transfer rule."},
  {"title": "Nutrient Cycles", "text": "Beyond energy, vital nutrients continuously cycle through ecosystems. We'll demystify the Carbon Cycle, from photosynthesis to respiration, and the Nitrogen Cycle, highlighting the crucial roles of various bacteria. These cycles are essential for life on Earth!"}
];
        let isPlaying = false;
