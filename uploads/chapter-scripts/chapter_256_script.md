...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Coordination Intro", "text": "Ever wondered how metals form such fascinating compounds? Welcome to Coordination Compounds! Here, a central metal ion forms special coordinate bonds with surrounding molecules or ions called ligands, creating unique and vibrant structures."},
  {"title": "Core Concepts", "text": "Let's dive into the core! The Coordination Number tells us how many ligands are directly attached to the central metal. Also, discover the powerful 'chelate effect,' where polydentate ligands form stable ring structures, significantly enhancing compound stability."},
  {"title": "Name & Isomers", "text": "Mastering their IUPAC nomenclature is crucial to describe these complex structures precisely. But wait, there's more! Coordination compounds exhibit various types of isomerism, leading to different arrangements and properties for the same chemical formula."},
  {"title": "Bonding Theories", "text": "How do these bonds form? While Valence Bond Theory provides initial insights, Crystal Field Theory, or CFT, truly unlocks the secrets! CFT explains how ligand fields split the d-orbitals, profoundly influencing the compound's color and magnetic properties."},
  {"title": "Magnets & Uses", "text": "This d-orbital splitting directly determines the compound's magnetic behavior, quantifiable by its magnetic moment. From catalysts to medicine, pigments, and even analytical chemistry, coordination compounds are everywhere, making them vital in modern science!"}
];
        let isPlaying = false;
