...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Atomic Nucleus", "text": "Ever wondered what's at the heart of every atom? Welcome to Nuclei! This chapter dives deep into the fascinating world of the atomic nucleus, exploring its fundamental nature and immense power."},
  {"title": "Size & Composition", "text": "The nucleus is tiny yet mighty, composed of protons and neutrons. We'll uncover how its size is measured, and understand the concept of mass defect – a crucial clue to nuclear energy."},
  {"title": "Stability & Energy", "text": "What holds the nucleus together despite strong repulsive forces? It's binding energy! We'll learn how this energy dictates nuclear stability and is directly linked to the mass defect we just discussed."},
  {"title": "Decay & Half-Life", "text": "Unstable nuclei undergo radioactive decay, transforming into more stable forms. We'll explore the decay law, understand the concept of half-life, and quantify radioactivity through 'activity'."},
  {"title": "Nuclear Reactions", "text": "Finally, we'll unravel the secrets of nuclear fission and fusion – processes that power stars and nuclear reactors. Discover the massive energy released in these reactions and their profound implications."}
];
        let isPlaying = false;
