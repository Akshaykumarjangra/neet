...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Oxygen Compounds Intro", "text": "Welcome, future doctors! Today, we're unlocking Chapter 11: Alcohols, Phenols, and Ethers. These crucial organic compounds are defined by their oxygen-containing functional groups, forming the backbone of many biological and industrial molecules."},
  {"title": "Synthesis & Prep", "text": "How do we create these versatile compounds? We'll explore various preparation methods, from the hydration of alkenes for alcohols to electrophilic substitution for phenols, and the classic Williamson synthesis for ethers."},
  {"title": "Properties & Oxidation", "text": "Next, we'll delve into their fascinating physical and chemical properties. A key concept here is the oxidation behavior of alcohols, differentiating primary, secondary, and tertiary types based on their reactivity."},
  {"title": "Acidity Trends", "text": "Understanding acidity is vital! We'll critically compare the acidic strength of alcohols and phenols, focusing on the resonance stabilization that makes phenols significantly more acidic than their alcoholic counterparts."},
  {"title": "Key Reactions", "text": "Finally, we'll master their characteristic reactions, including the important Williamson Ether Synthesis. This chapter equips you with essential knowledge for tackling complex organic chemistry questions in NEET."}
];
        let isPlaying = false;
