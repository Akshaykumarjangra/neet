...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Reaction Speed", "text": "Ever wondered why some reactions explode instantly while others take ages? Chemical Kinetics is your answer! We'll explore how fast reactions go, what makes them tick, and their step-by-step journey."},
  {"title": "Rate Factors", "text": "The rate of reaction is simply how quickly concentrations change over time. It's influenced by factors like concentration, temperature, surface area, and the presence of a catalyst."},
  {"title": "Rate Order", "text": "The Rate Law, Rate = k[A]^m[B]^n, describes the experimental dependence of reaction rate on reactant concentrations. Remember, the reaction order is always determined experimentally, not from stoichiometry!"},
  {"title": "Energy Barrier", "text": "Integrated rate laws help us predict concentration over time for zero, first, and second-order reactions. Don't forget Activation Energy – the minimum energy reactants need to overcome and transform into products."},
  {"title": "Arrhenius Mechanism", "text": "The Arrhenius equation, k = Ae^(-Ea/RT), quantifies how temperature affects the rate constant. Finally, we'll unravel reaction mechanisms, understanding that the slowest elementary step dictates the overall reaction rate."}
];
        let isPlaying = false;
