...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "p-Block Unveiled", "text": "Welcome, NEET Aspirants! Today, we dive into the fascinating world of p-Block elements, spanning Groups 13 to 18. Prepare to explore their incredible diversity in properties and chemical behavior."},
  {"title": "Nitrogen Family", "text": "Let's begin with Group 15, the Nitrogen family, and uncover the unique trends in their physical and chemical properties. We'll examine the formation and importance of compounds like ammonia and nitric acid."},
  {"title": "Oxygen Halogens", "text": "Next, we move to Group 16, the Oxygen family, and Group 17, the highly reactive Halogens. Understand their distinct chemical reactivity and delve into the structures and properties of various oxoacids."},
  {"title": "Inert Pair, Noble", "text": "Discover the intriguing 'Inert Pair Effect,' explaining the stability of lower oxidation states for heavier p-block elements. Then, we'll explore Group 18, the Noble Gases, and their surprising chemistry."},
  {"title": "Real-World Impact", "text": "From fertilizers to disinfectants, p-Block elements are vital in countless applications. Grasping their trends, compounds, and key concepts like halogen reactivity and oxoacids is crucial for your NEET success."}
];
        let isPlaying = false;
