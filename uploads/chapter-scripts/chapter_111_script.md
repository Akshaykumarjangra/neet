...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Respiration", "text": "Welcome, NEET aspirants! Today, we uncover Respiration in Plants – the vital process where plants release stored energy from organic compounds like glucose to fuel their life functions. Unlike photosynthesis, respiration constantly occurs in all living plant cells, day and night."},
  {"title": "Energy Equation", "text": "At its core, respiration is about converting glucose and oxygen into carbon dioxide, water, and crucially, energy in the form of 38 ATP molecules. This grand biochemical equation, C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + Energy, defines the process."},
  {"title": "Aerobic Stages", "text": "For efficient energy extraction, aerobic respiration unfolds in a series of four interconnected stages: Glycolysis, the Link Reaction, the Krebs Cycle, and finally, the Electron Transport Chain. Each stage plays a critical role in maximizing ATP yield."},
  {"title": "Glycolysis Explained", "text": "Our journey begins with Glycolysis, also known as the EMP pathway, occurring in the cytoplasm. Here, a single glucose molecule is broken down into two pyruvate molecules, yielding a net of 2 ATP and 2 NADH, preparing for the next steps."},
  {"title": "Link Reaction", "text": "Next up is the Link Reaction, taking place within the mitochondria. Each pyruvate molecule from glycolysis is decarboxylated and oxidized, converting it into Acetyl-CoA, while also producing 2 NADH per glucose molecule, ready for the Krebs cycle."}
];
        let isPlaying = false;
