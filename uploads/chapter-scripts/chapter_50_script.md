...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Welcome Amines!", "text": "Hello future doctors! Get ready to explore Amines, fascinating organic compounds derived from ammonia. These nitrogen-containing molecules are everywhere, from medicines to dyes, and understanding them is crucial for NEET."},
  {"title": "Classify & Prepare", "text": "Amines are classified as primary, secondary, or tertiary based on nitrogen substitution. We'll dive into their synthesis, including the brilliant Hoffmann Bromamide degradation, a key method for preparing primary amines."},
  {"title": "Basicity Unveiled", "text": "Amines act as Lewis bases due to the lone pair on nitrogen. We'll unravel the factors affecting their basicity, like inductive effect and solvation, and master the Basicity Trend in different phases."},
  {"title": "React & Identify", "text": "Discover the diverse reactions of amines, from acylation to alkylation. Don't miss the Carbylamine Test, a distinctive reaction used to identify primary amines with its pungent smell!"},
  {"title": "Diazonium Power", "text": "Finally, we'll explore diazonium salts, formed through the vital Diazotization reaction. These versatile intermediates are indispensable for synthesizing a wide range of aromatic compounds, a true powerhouse in organic chemistry."}
];
        let isPlaying = false;
