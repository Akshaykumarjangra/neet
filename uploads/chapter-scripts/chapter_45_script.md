...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Our Chemical Planet", "text": "Welcome to Environmental Chemistry! Our planet is a complex lab where chemical processes constantly shape our air, water, and soil. Let's explore how these interactions impact us and what we can do to protect it."},
  {"title": "Air Pollutants", "text": "Our atmosphere faces threats from various pollutants like CO, SO₂, and NOₓ, often from combustion and industry. These harmful gases cause health problems and contribute to larger environmental issues."},
  {"title": "Smog & Acid", "text": "Ever heard of smog? Classical smog forms in cold, humid conditions, while photochemical smog thrives in warm, sunny weather. We'll also uncover how SO₂ and NOₓ lead to acid rain, damaging ecosystems and structures."},
  {"title": "Global Warming", "text": "The Greenhouse Effect, caused by gases like CO₂ and CH₄, traps infrared radiation, leading to global warming and climate change. We'll also reveal how CFCs dangerously deplete our protective ozone layer."},
  {"title": "Water & Solutions", "text": "Water pollution is measured by parameters like BOD and DO, with eutrophication being a major concern in water bodies. Finally, discover Green Chemistry – a proactive approach to design processes that minimize pollution and environmental impact."}
];
        let isPlaying = false;
