...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Organic World", "text": "Welcome to the captivating world of Organic Chemistry! It's all about carbon, a unique element forming millions of compounds due to its special ability to catenate and form four bonds. Get ready to unlock the secrets behind life's molecules!"},
  {"title": "Hybridization Shapes", "text": "Carbon's versatility comes from hybridization. Learn how sp³, sp², and sp hybridization dictate molecular geometry – from tetrahedral to trigonal planar to linear – and define bond angles. This concept is key to understanding 3D structures."},
  {"title": "Naming Compounds", "text": "Ever wondered how organic compounds get their names? We'll master IUPAC nomenclature, a systematic method using prefixes, root words, and suffixes. This ensures every compound has a unique identity, making communication clear and precise."},
  {"title": "Isomerism Unveiled", "text": "Prepare to explore isomerism, where compounds share the same molecular formula but differ in structure or spatial arrangement. We'll differentiate between structural isomers like chain and functional group, and stereoisomers such as geometrical and optical isomers."},
  {"title": "Reactivity Insights", "text": "Finally, we'll delve into electron displacement effects like inductive and resonance, crucial for understanding molecular stability and reactivity. Discover how these effects influence the formation of transient species like carbocations and free radicals, driving organic reactions."}
];
        let isPlaying = false;
