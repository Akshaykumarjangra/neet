...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Hydrocarbons Unveiled", "text": "Welcome, NEET aspirants! Today, we're diving into Hydrocarbons – the fundamental building blocks of organic chemistry, made solely of carbon and hydrogen. From fuels to plastics, these compounds are everywhere, and understanding them is crucial for your success!"},
  {"title": "Alkanes: Saturated Stories", "text": "First up are Alkanes, our saturated hydrocarbons with single bonds, following the CnH2n+2 formula. Think of them as stable molecules, primarily undergoing substitution reactions through a free radical mechanism under specific conditions."},
  {"title": "Alkenes & Markovnikov", "text": "Next, we explore Alkenes, featuring a carbon-carbon double bond that makes them highly reactive. Here, Markovnikov's Rule becomes vital: in addition reactions, the hydrogen atom adds to the carbon with more hydrogens already attached."},
  {"title": "Benzene: Aromatic Core", "text": "Moving beyond straight chains, we encounter Benzene, the iconic aromatic hydrocarbon. Imagine a stable hexagonal ring with delocalized pi electrons, where all C-C bonds are identical and its stability is explained by resonance."},
  {"title": "Electrophilic Substitution", "text": "Benzene's signature reaction is Electrophilic Substitution, where an electrophile replaces a hydrogen atom, preserving its aromaticity. Existing groups on the ring have 'directive effects,' guiding where new substituents will attach, either ortho-para or meta."}
];
        let isPlaying = false;
