...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Breathing Basics", "text": "Welcome to Chapter 17, where we unravel the amazing process of breathing and gas exchange! Let's trace air's journey: from nostrils, through the pharynx, larynx, trachea, bronchi, and finally into the tiny alveoli for exchange."},
  {"title": "Breathing Mechanism", "text": "How do we breathe? Inspiration involves diaphragm contraction, increasing thoracic volume and decreasing pressure, drawing air in. Expiration is the passive opposite, as muscles relax, decreasing volume and pushing air out."},
  {"title": "Alveoli Exchange", "text": "Gas exchange occurs in millions of alveoli, tiny sacs with incredibly thin, moist walls and a rich blood supply. Their massive surface area, around 70-80 square meters, ensures efficient oxygen absorption and carbon dioxide release."},
  {"title": "Oxygen Delivery", "text": "Oxygen travels mainly via hemoglobin, forming oxyhemoglobin, with each molecule binding four O₂. The Bohr Effect is key: active tissues with low pH, high CO₂, and temperature get more oxygen released from hemoglobin."},
  {"title": "CO2 Transport", "text": "Carbon dioxide is transported primarily as bicarbonate ions, some as carbaminohemoglobin, and a small part dissolved in plasma. Vital Capacity measures the maximum air you can move in and out, a crucial respiratory measurement."}
];
        let isPlaying = false;
