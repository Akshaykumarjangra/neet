...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Transport Needs", "text": "Plants are incredible autotrophs, needing to move water from deep roots to high leaves, and food from leaves to all parts. But how do they manage this vast transport without a heart or a circulatory system like animals?"},
  {"title": "Plant's Transport System", "text": "Instead of a pump, plants rely on specialized vascular tissues: xylem for water and minerals, and phloem for organic nutrients. These tissues, coupled with various physical and physiological processes, facilitate efficient substance movement throughout the plant body."},
  {"title": "Water Potential Basics", "text": "The fundamental concept driving water movement is water potential, Ψw. Water always moves passively from a region of higher water potential to one of lower water potential, a principle crucial for understanding plant water dynamics. Remember, Ψw is the sum of solute, pressure, and matric potentials!"},
  {"title": "Plasmolysis, Turgor", "text": "When a plant cell is placed in a hypertonic solution, its protoplast shrinks away from the cell wall, a process called plasmolysis. Conversely, turgor pressure, the pressure exerted by the cell's contents against its wall, is essential for providing mechanical support and maintaining plant rigidity."},
  {"title": "Root Water Uptake", "text": "Water absorption by roots follows three primary pathways: the apoplast pathway, moving through cell walls and intercellular spaces; the symplast pathway, via plasmodesmata connecting cell cytoplasms; and the transmembrane pathway, involving repeated crossing of cell membranes."}
];
        let isPlaying = false;
