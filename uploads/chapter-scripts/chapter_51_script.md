...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Biomolecules Unveiled", "text": "Welcome, NEET aspirants! Today we dive into Biomolecules, the essential organic compounds forming the basis of life. We'll explore carbohydrates, proteins, nucleic acids, and vitamins, understanding their crucial roles in biological systems."},
  {"title": "Carbs & Sugars", "text": "Carbohydrates are our primary energy source, classified into monosaccharides, disaccharides, and polysaccharides. We'll learn about reducing sugars, which have a free aldehyde or ketone group, and their importance in biological tests like Benedict's."},
  {"title": "Proteins & Bonds", "text": "Proteins are vital for structure, function, and regulation, built from amino acids linked by strong peptide bonds. We'll understand how these amide linkages form between the carboxyl and amino groups, creating complex protein structures."},
  {"title": "DNA, RNA Basics", "text": "Nucleic acids, DNA and RNA, carry genetic information, dictating all life processes. Discover the concept of base pairing – adenine with thymine/uracil, and guanine with cytosine – the fundamental rule for genetic code replication and expression."},
  {"title": "Vitamins & Health", "text": "Finally, we'll explore vitamins, organic compounds essential in small amounts for normal metabolic function. Learn about their classification into fat-soluble (A, D, E, K) and water-soluble (B-complex, C) types, and their diverse roles in maintaining health."}
];
        let isPlaying = false;
