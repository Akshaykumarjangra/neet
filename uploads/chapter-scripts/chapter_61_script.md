...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Metal Extraction Basics", "text": "Ever wondered how we get pure metals from rocks? This is metallurgy! We'll explore the journey from ore, a mineral from which metal can be profitably extracted, to pure metal, leaving behind impurities called gangue."},
  {"title": "Ore Concentration", "text": "First, we concentrate the ore by removing gangue using various methods. These include gravity separation, magnetic separation, froth flotation for sulfide ores, and chemical leaching depending on the ore type."},
  {"title": "Crude Metal Extraction", "text": "Next, we convert the concentrated ore into crude metal. Calcination heats carbonates without air, while roasting heats sulfides with air. Highly reactive metals are extracted electrolytically, whereas moderate ones use carbon reduction."},
  {"title": "Metal Refining", "text": "Crude metals often need further purification through refining. Electrolytic refining uses an impure metal anode and a pure metal cathode, with metal ions traveling through an electrolyte, leaving impurities behind as anode mud."},
  {"title": "Special Refining Methods", "text": "For ultra-pure metals, special techniques are employed. Zone refining is crucial for semiconductors, while the Mond process purifies nickel. The Van Arkel method ensures high purity for titanium and zirconium."}
];
        let isPlaying = false;
