...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Animal Kingdom Intro", "text": "Welcome to the incredible world of the Animal Kingdom! Prepare to explore the breathtaking diversity of animal life, from the simplest sponges to complex mammals. We'll uncover how scientists classify these amazing creatures based on their unique body plans."},
  {"title": "Organization & Symmetry", "text": "Animals are first grouped by their levels of organization, ranging from cellular to complex organ systems. Another key feature is body symmetry: asymmetrical, radially symmetrical like jellyfish, or bilaterally symmetrical like most advanced animals."},
  {"title": "Germ Layers & Coelom", "text": "Next, we examine germ layers – diploblastic animals have two, while triploblastic have three developmental layers. We'll also differentiate between acoelomates, pseudocoelomates, and coelomates based on the presence and nature of their body cavity."},
  {"title": "Invertebrate Diversity", "text": "Dive into fascinating phyla like Cnidaria, famous for their stinging cells and radial symmetry. Then, explore Arthropoda, the largest phylum, characterized by jointed legs and a chitinous exoskeleton, dominating animal life!"},
  {"title": "Meet the Chordates", "text": "Finally, we arrive at the Chordates, our own phylum! Remember their four defining features: a notochord, dorsal hollow nerve cord, pharyngeal gill slits, and a post-anal tail at some stage in their development."}
];
        let isPlaying = false;
