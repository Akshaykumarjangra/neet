...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Locomotion Basics", "text": "Ever wondered how we move, from a simple blink to a marathon run? Welcome to Locomotion and Movement! We'll explore the incredible human musculoskeletal system, the framework that gives us shape and the power that drives every action."},
  {"title": "Skeletal Framework", "text": "Our body's support system, the human skeleton, comprises 206 bones divided into the Axial and Appendicular skeletons. This bony framework provides protection, support, and the attachment points for muscles, enabling all our movements."},
  {"title": "Joint Diversity", "text": "Movement isn't just about bones; it's about how they connect! We'll dive into diverse synovial joints like ball & socket and hinge, allowing varied motions. Plus, discover the vertebral column, our flexible backbone protecting the spinal cord."},
  {"title": "Sarcomere Power", "text": "Zooming into muscles, we find the microscopic sarcomere, the fundamental unit of contraction, stretching between two Z-lines. It's an intricate dance of actin and myosin filaments, precisely arranged to generate force."},
  {"title": "Sliding Filaments", "text": "Unravel the Sliding Filament Theory, where myosin heads pull actin filaments, shortening the sarcomere and causing muscle contraction. This energy-intensive process, fueled by ATP, is the secret behind every move you make."}
];
        let isPlaying = false;
