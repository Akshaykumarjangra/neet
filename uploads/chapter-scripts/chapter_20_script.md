...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Magnetism Unveiled", "text": "Welcome, future doctors, to Chapter 5: Magnetism and Matter! This chapter unravels the fascinating world of magnetism, from tiny dipoles to Earth's grand magnetic shield. We'll explore how materials respond to magnetic fields and the technology built upon these principles."},
  {"title": "Dipoles & Torque", "text": "At the heart of magnetism are magnetic dipoles, much like electric dipoles. Understand their magnetic dipole moment and how they experience torque when placed in an external magnetic field. This fundamental interaction governs many magnetic phenomena."},
  {"title": "Earth's Field", "text": "Did you know Earth itself is a giant magnet? We'll delve into Earth's magnetic field and its components. Then, explore how materials acquire magnetization and quantify their magnetic response using terms like magnetic susceptibility."},
  {"title": "Magnetic Materials", "text": "Materials exhibit diverse magnetic behaviors, leading to their classification into diamagnetic, paramagnetic, and ferromagnetic substances. Discover the unique properties and microscopic origins behind each type. This distinction is crucial for understanding material applications."},
  {"title": "Hysteresis & Use", "text": "Finally, we'll examine hysteresis, a memory effect seen in ferromagnetic materials, crucial for permanent magnets and data storage. Understand the hysteresis loop and its implications for various technological applications, from motors to hard drives."}
];
        let isPlaying = false;
