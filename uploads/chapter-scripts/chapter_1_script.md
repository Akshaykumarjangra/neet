...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Welcome to Physics", "text": "Ever wondered how the universe works, or why things fall? Physics is the fundamental science that unravels these mysteries, from the tiniest particles to the vast cosmos. It's about understanding the basic laws governing nature."},
  {"title": "Scope of Physics", "text": "Physics isn't just equations; it's the engine behind technology, medicine, and space exploration. Its vast scope ranges from quantum mechanics to astrophysics, constantly pushing the boundaries of human knowledge and innovation."},
  {"title": "Scientific Method", "text": "How do physicists discover these laws? Through the scientific method: observation, hypothesis, experimentation, and validation. This systematic approach ensures our understanding of the world is logical and evidence-based."},
  {"title": "Fundamental Forces", "text": "At its core, physics identifies four fundamental forces that govern all interactions: strong, weak, electromagnetic, and gravitational. These forces dictate everything from nuclear stability to planetary orbits."},
  {"title": "Conservation Laws", "text": "A cornerstone of physics are the conservation laws, like conservation of energy, momentum, and charge. These powerful principles state that certain quantities remain constant, providing profound insights into the universe's unchanging rules."}
];
        let isPlaying = false;
