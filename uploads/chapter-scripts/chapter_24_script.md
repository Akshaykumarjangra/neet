...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Ray Optics Intro", "text": "Welcome to Ray Optics, where we unravel the mysteries of light using simple ray diagrams! This chapter is fundamental for understanding how light interacts with different surfaces and forms images, a crucial topic for NEET."},
  {"title": "Mirrors & Reflection", "text": "First, let's dive into reflection! We'll explore how light bounces off surfaces, understand the laws of reflection, and master concave and convex mirrors using the Mirror Formula to locate images and calculate magnification."},
  {"title": "Lenses & Refraction", "text": "Next, we tackle refraction – the bending of light as it passes from one medium to another. We'll learn Snell's Law, analyze how lenses form images, and apply the Lens Formula to solve numerical problems for both converging and diverging lenses."},
  {"title": "Total Internal Reflection", "text": "Prepare to be amazed by Total Internal Reflection! Discover the conditions under which light completely reflects back into a denser medium, learn about the critical angle, and see its incredible applications in optical fibers and prisms."},
  {"title": "Optical Instruments", "text": "Finally, we'll put our knowledge to use by exploring the fascinating world of optical instruments. Understand the working principles of microscopes and telescopes, and grasp how they extend the limits of human vision, a high-yield area for NEET questions!"}
];
        let isPlaying = false;
