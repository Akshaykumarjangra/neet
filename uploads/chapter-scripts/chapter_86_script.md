...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Biotech Unveiled", "text": "Welcome to Biotechnology: Principles and Processes! Discover how we harness biological systems to create amazing products. This chapter bridges zoology and engineering, exploring the manipulation of DNA to revolutionize medicine and agriculture."},
  {"title": "Cutting & Carrying", "text": "Our journey begins with key tools: restriction enzymes, the 'molecular scissors' that precisely cut DNA at specific sites. Then, we use cloning vectors like plasmids, the 'delivery vehicles' that carry our desired gene into host cells."},
  {"title": "Amplify & Join", "text": "Need more DNA? Polymerase Chain Reaction, or PCR, rapidly amplifies specific DNA sequences through repeated cycles of denaturation, annealing, and extension. After cutting and amplifying, DNA ligase acts as the 'molecular glue' to join the desired DNA fragment into the vector."},
  {"title": "Insert & Identify", "text": "Once our recombinant DNA is ready, we introduce it into host cells through transformation using methods like heat shock or electroporation. Crucially, we then select for successful recombinants using markers, often seen with techniques like blue-white screening."},
  {"title": "Biotech's Impact", "text": "From lab bench to industrial production, bioreactors are large vessels that provide optimal conditions for culturing organisms to yield products on a massive scale. Biotechnology continues to transform healthcare, agriculture, and environmental solutions, shaping our future."}
];
        let isPlaying = false;
