...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Intro Electrochemistry", "text": "Ever wondered how chemical reactions can produce electricity, or how electricity drives chemical changes? Welcome to Electrochemistry, the fascinating bridge between chemical energy and electrical energy, fundamental for NEET!"},
  {"title": "Galvanic Cells", "text": "We'll start by exploring galvanic cells, which spontaneously convert chemical energy into electrical energy. Understand electrode potentials and how to calculate cell EMF, the driving force behind these reactions."},
  {"title": "Nernst Equation", "text": "Next, master the Nernst Equation, crucial for determining electrode potentials and cell EMF under non-standard conditions. We'll also connect these concepts to Gibbs Free Energy, revealing the spontaneity of electrochemical processes."},
  {"title": "Electrolysis, Faraday", "text": "Then, dive into electrolysis, where electrical energy drives non-spontaneous chemical reactions. Learn Faraday's Laws of Electrolysis to quantify the products formed, a key concept for many industrial applications."},
  {"title": "Applications, Corrosion", "text": "Finally, we'll touch upon the practical applications of electrochemistry, from batteries to electroplating, and understand the science behind corrosion. Get ready to ace all electrochemistry questions in NEET!"}
];
        let isPlaying = false;
