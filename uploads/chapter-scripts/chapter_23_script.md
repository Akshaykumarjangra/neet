...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "EM Waves Intro", "text": "Welcome, future doctors! Today, we demystify Electromagnetic Waves – fascinating transverse waves of oscillating electric and magnetic fields. They propagate through space, carrying energy without needing any physical medium."},
  {"title": "Transverse Nature", "text": "Picture this: the electric and magnetic fields in an EM wave oscillate perpendicular to each other, and both are perpendicular to the wave's direction of propagation. This defines their unique transverse nature, with E and B fields always in phase."},
  {"title": "Wave Speed", "text": "The speed of an EM wave in vacuum is a universal constant, 'c', approximately 3 x 10^8 m/s. This speed is intrinsically linked to the permittivity and permeability of free space, a fundamental connection derived from Maxwell's equations."},
  {"title": "Energy Transport", "text": "EM waves aren't just vibrations; they transport energy and momentum! The Poynting Vector, represented by S = (1/μ₀)(E x B), quantifies this energy flow per unit area per unit time, indicating both magnitude and direction."},
  {"title": "EM Spectrum", "text": "From radio waves to gamma rays, the electromagnetic spectrum encompasses a vast range of frequencies and wavelengths. Understanding their order and properties – like radio, microwave, infrared, visible, UV, X-ray, and gamma – is crucial for NEET."}
];
        let isPlaying = false;
