...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Evolution's Journey", "text": "Ever wondered how life began or why species are so diverse? Chapter 7, Evolution, unravels the incredible story of life's origins and the mechanisms driving its continuous change over millions of years."},
  {"title": "Life's Genesis", "text": "Our journey begins with Chemical Evolution, where simple inorganic molecules on early Earth transformed into complex organic compounds. The Oparin-Haldane hypothesis and Miller-Urey experiment provide key insights into this primordial soup."},
  {"title": "Darwin's Insight", "text": "Then came Charles Darwin's revolutionary theory of Natural Selection. It explains how variations within populations, coupled with competition, lead to the 'survival of the fittest,' driving adaptation and evolution."},
  {"title": "Evidence Abounds", "text": "Evolution isn't just a theory; it's supported by vast evidence. Homologous organs, like vertebrate forelimbs, show common ancestry, while analogous organs demonstrate convergent evolution for similar functions."},
  {"title": "Human Chronicle", "text": "Finally, we trace the fascinating story of Human Evolution, from early bipedal Australopithecus to tool-making Homo habilis, and eventually to our own species, Homo sapiens, with our complex brains and cultures."}
];
        let isPlaying = false;
