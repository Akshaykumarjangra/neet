...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Reaction Balance", "text": "Ever wondered why some reactions stop halfway? Welcome to Equilibrium, where reactions reach a perfect balance! It's a dynamic state where forward and reverse reaction rates become equal, making concentrations appear constant."},
  {"title": "Dynamic K", "text": "Even at equilibrium, molecules are actively transforming! We quantify this balance using the Equilibrium Constant, K, which tells us if products or reactants are favored at a given temperature."},
  {"title": "Le Chatelier's", "text": "What happens if we disturb this delicate balance? Le Chatelier's Principle explains that the system will shift to counteract any applied stress, whether it's a change in concentration, pressure, or temperature."},
  {"title": "pH Power", "text": "Now, let's dive into ionic equilibrium, especially in acid-base chemistry! We'll decode the power of hydrogen using pH and pOH scales to precisely measure acidity and basicity of solutions."},
  {"title": "Buffers Solubility", "text": "Discover special buffer solutions that resist pH changes, and explore the Solubility Product, Ksp, to predict the precipitation of sparingly soluble salts. Mastering these concepts is crucial for NEET success!"}
];
        let isPlaying = false;
