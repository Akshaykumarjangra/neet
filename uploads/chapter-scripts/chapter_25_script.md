...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Wave Optics Intro", "text": "Ever wondered how light bends around corners or why soap bubbles show vibrant colors? Welcome to Wave Optics, where we'll uncover the wave nature of light, explaining phenomena like interference, diffraction, and polarization!"},
  {"title": "Interference YDSE", "text": "Interference is when two light waves combine to form a resultant wave of greater or lower amplitude. Young's Double Slit Experiment, or YDSE, beautifully demonstrates this, revealing bright and dark fringes based on path difference and fringe width."},
  {"title": "Light Diffraction", "text": "Diffraction is the bending of light waves as they pass around obstacles or through small apertures. We'll explore the conditions for diffraction, observing how light spreads out, creating distinct patterns of minima and maxima."},
  {"title": "Light Polarization", "text": "Unlike sound waves, light waves can be polarized, meaning their oscillations are restricted to a single plane. Understanding polarization helps us control light's direction and properties for various applications."},
  {"title": "Malus Brewster's", "text": "Malus' Law quantifies the intensity of polarized light after passing through an analyzer. Brewster's Law, on the other hand, describes the angle at which unpolarized light becomes perfectly polarized upon reflection, a crucial concept for glare reduction."}
];
        let isPlaying = false;
