...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "d & f Elements", "text": "Welcome to the fascinating world of d- and f-block elements! These transition and inner-transition metals are known for their unique properties, forming a bridge between reactive s- and p-blocks."},
  {"title": "Variable Oxidation", "text": "One hallmark is their variable oxidation states, arising from the involvement of both (n-1)d and ns electrons in bonding. This versatility leads to a rich chemistry and diverse compounds."},
  {"title": "Lanthanoid Contraction", "text": "Dive into Lanthanoid Contraction, the steady decrease in atomic and ionic radii across the lanthanoid series. This phenomenon, due to poor shielding by 4f electrons, has significant consequences for subsequent elements."},
  {"title": "Magnetic Properties", "text": "Explore the intriguing magnetic properties of these elements, often exhibiting paramagnetism due to unpaired electrons. We'll learn how to calculate magnetic moments and understand their behavior in a magnetic field."},
  {"title": "Colorful Catalysts", "text": "Beyond magnetism, d- and f-block elements are famous for forming vibrant colored ions and acting as crucial catalysts in many industrial processes. We'll also touch upon key compounds like potassium permanganate and dichromate."}
];
        let isPlaying = false;
