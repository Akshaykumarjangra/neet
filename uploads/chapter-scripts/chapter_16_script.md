...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Electric Beginnings", "text": "Welcome, future doctors, to the exciting world of Electrostatics! We begin our journey understanding electric charges, the fundamental property of matter that governs fascinating interactions around us. These charges are the building blocks for electric forces and fields."},
  {"title": "Forces & Charges", "text": "Did you know electric charge is quantized and conserved? This means it exists in discrete packets and cannot be created or destroyed. The force between these charges is precisely described by Coulomb's Law, a fundamental principle for calculating electrostatic interactions."},
  {"title": "Electric Fields", "text": "Every charge creates an invisible region around it called an electric field. We visualize these fields using electric field lines, which show the direction and strength of the force a test charge would experience. Understanding these lines is crucial for predicting charge behavior."},
  {"title": "Dipoles & Flux", "text": "An electric dipole, a pair of equal and opposite charges separated by a small distance, generates its own unique field pattern. We'll also explore electric flux, a measure of how many electric field lines pass through a given surface, paving the way for advanced calculations."},
  {"title": "Gauss's Law", "text": "Finally, we unlock the power of Gauss's Law, a remarkable tool that simplifies the calculation of electric fields for symmetric charge distributions. This law, relating total electric flux to enclosed charge, is indispensable for solving complex problems efficiently."}
];
        let isPlaying = false;
