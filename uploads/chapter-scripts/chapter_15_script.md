...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Wave Introduction", "text": "Ever wonder how sound travels or light reaches us? It's all thanks to waves! Join us as we dive into the fascinating world of wave motion, a fundamental concept in physics."},
  {"title": "Wave Essentials", "text": "Waves are disturbances that transfer energy without transferring matter. We'll categorize them into transverse and longitudinal types, and define key parameters like amplitude, wavelength, frequency, and wave speed."},
  {"title": "Standing Waves", "text": "Explore the magic of superposition, where two or more waves combine. This leads us to the creation of standing waves, crucial for understanding musical instruments, along with reflection and refraction."},
  {"title": "Beats & Interference", "text": "Discover how waves interact through interference, creating fascinating patterns. We'll also learn about beats, a phenomenon where two slightly different frequencies produce periodic variations in sound intensity."},
  {"title": "Sound & Doppler", "text": "Finally, we'll focus on sound waves, their characteristics, and how their speed depends on the medium. Understand the intriguing Doppler Effect, explaining why a siren's pitch changes as it passes by, and wave speed on a string."}
];
        let isPlaying = false;
