...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Biotech's Impact", "text": "Welcome, future doctors! Today, we dive into 'Biotechnology and its Applications,' a chapter where science transforms life. Discover how genetic engineering is revolutionizing medicine, agriculture, and our understanding of life itself."},
  {"title": "Medical Breakthroughs", "text": "From creating life-saving drugs to correcting genetic defects, biotechnology is at the forefront of healthcare. Learn about recombinant insulin, a game-changer for diabetics, and the promise of gene therapy in treating inherited diseases like ADA deficiency."},
  {"title": "Crop Revolution", "text": "Biotechnology isn't just for medicine; it's transforming agriculture too! Explore how Bt Crops like cotton resist pests naturally, and how 'Golden Rice' combats Vitamin A deficiency, improving global food security."},
  {"title": "Advanced Techniques", "text": "Dive into RNA interference, a powerful mechanism for gene silencing, used even for pest resistance in plants. We'll also discuss crucial ethical considerations like biopiracy and the vital role of biosafety regulations in protecting our future."},
  {"title": "Shaping Tomorrow", "text": "Biotechnology offers incredible solutions, but also raises important questions about modifying life. Understanding these applications and their ethical dimensions is key to harnessing its power responsibly for a better tomorrow."}
];
        let isPlaying = false;
