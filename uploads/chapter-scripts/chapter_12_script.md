...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "What is Thermodynamics?", "text": "Welcome to Chapter 12: Thermodynamics! Ever wondered how refrigerators cool or engines power cars? This branch of physics unlocks these secrets, exploring heat, work, and energy transformations."},
  {"title": "First Law: Energy", "text": "At its heart, the First Law of Thermodynamics is simply the conservation of energy. It states that energy cannot be created or destroyed, only transferred or changed forms, connecting internal energy, heat, and work."},
  {"title": "Thermodynamic Processes", "text": "We'll then dive into key thermodynamic processes like isothermal, adiabatic, isobaric, and isochoric. Each process describes how a system's state changes under specific conditions, crucial for understanding heat exchange and work done."},
  {"title": "Heat Engines: Efficiency", "text": "Next, discover the fascinating world of heat engines, devices that convert thermal energy into useful mechanical work. We'll analyze their efficiency, focusing on the ideal Carnot cycle and its practical implications."},
  {"title": "Entropy: Disorder", "text": "Finally, we introduce entropy, a fundamental concept representing disorder or randomness in a system. This leads us to the Second Law of Thermodynamics, explaining the direction of spontaneous processes and energy's ultimate fate."}
];
        let isPlaying = false;
