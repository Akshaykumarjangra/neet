...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Electric Energy", "text": "Welcome to Chapter 2! We're diving into Electrostatic Potential and Capacitance, exploring an energy-based way to describe electric fields. Understand potential difference and the work done by electric forces."},
  {"title": "Potential Basics", "text": "First, we define electrostatic potential for a point charge and its distribution. Crucially, we'll uncover the fundamental relationship between electric field and potential, visualizing them through equipotential surfaces."},
  {"title": "Capacitors Intro", "text": "Next, let's introduce capacitors – devices designed to store electric charge and energy. We'll focus on the parallel plate capacitor, understanding its structure and how its capacitance is determined."},
  {"title": "Combine Capacitors", "text": "Learn how to combine capacitors in series and parallel configurations, calculating their equivalent capacitance. We'll also explore the fascinating role of dielectric materials in enhancing a capacitor's storage capability."},
  {"title": "Stored Energy", "text": "Finally, we'll quantify the energy stored within a capacitor and within an electric field itself. Master these concepts for a deeper understanding of electricity, crucial for your NEET success!"}
];
        let isPlaying = false;
