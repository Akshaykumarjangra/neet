...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Kinetic Theory Intro", "text": "Ever wondered how the microscopic world of atoms dictates macroscopic properties like pressure and temperature? Kinetic Theory is our bridge, connecting the chaotic dance of molecules to the observable behavior of gases. Prepare to unravel the secrets of ideal gas behavior!"},
  {"title": "Pressure & Motion", "text": "Imagine countless gas molecules constantly colliding with the container walls. These incessant impacts, though minuscule individually, generate a collective force per unit area – that's pressure! We'll explore the direct relationship between molecular momentum transfer and the pressure exerted by a gas."},
  {"title": "Temperature & KE", "text": "What truly defines temperature? Kinetic Theory reveals it's a direct measure of the average translational kinetic energy of the gas molecules. The hotter the gas, the faster its particles are zipping around, making this a fundamental concept for NEET!"},
  {"title": "Molecular Speeds", "text": "Not all molecules move at the same speed; there's a distribution! We'll delve into different molecular speeds – like root mean square, average, and most probable – and understand how the total internal energy of an ideal gas relates to the sum of these molecular kinetic energies."},
  {"title": "Mean Free Path", "text": "Do molecules travel endlessly without interruption? Not quite! The mean free path is the average distance a molecule travels between successive collisions with other molecules, a crucial factor influencing transport phenomena like diffusion and viscosity in gases."}
];
        let isPlaying = false;
