...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Intro Biodiversity", "text": "Welcome to Chapter 15: Biodiversity and Conservation! Biodiversity is the incredible variety of life on Earth, spanning genetic, species, and ecosystem levels. Understanding and conserving this rich diversity is crucial for our planet's health."},
  {"title": "Diversity Levels", "text": "Biodiversity exists at three main levels: genetic diversity within a species, species diversity across different organisms, and ecosystem diversity in different habitats. Each level contributes to the overall richness and resilience of life."},
  {"title": "Species Area", "text": "The Species-Area Relationship shows that larger geographical areas generally support a greater number of species. This ecological principle helps us predict species richness and understand the impact of habitat size."},
  {"title": "Threats to Life", "text": "Unfortunately, biodiversity faces severe threats often termed the 'Evil Quartet': habitat loss and fragmentation, overexploitation, alien species invasions, and co-extinctions. These factors accelerate species extinction rates globally."},
  {"title": "Saving Biodiversity", "text": "Conservation efforts are vital, employing both in-situ methods like national parks and ex-situ methods such as zoos and seed banks. Protecting biodiversity ensures ecological stability and human well-being for future generations."}
];
        let isPlaying = false;
