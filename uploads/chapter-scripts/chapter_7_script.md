...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Beyond Point Masses", "text": "Welcome to Chapter 7! We're moving beyond single point masses to understand how entire systems of particles behave. Get ready to explore the fascinating world of rotational motion."},
  {"title": "Center of Mass", "text": "First, let's master the concept of the Center of Mass – the unique point where an object's entire mass seems to be concentrated. Understanding this simplifies complex motion for any system of particles."},
  {"title": "Torque Explained", "text": "Next up is Torque, the rotational equivalent of force! It's what makes objects rotate or change their rotational state. Think of it as the twisting force that opens a door or tightens a bolt."},
  {"title": "Moment of Inertia", "text": "Introducing Moment of Inertia, rotational motion's answer to mass. It quantifies an object's resistance to changes in its rotational motion, depending on both mass and its distribution."},
  {"title": "Angular Momentum", "text": "Finally, we delve into Angular Momentum and the exciting world of Rotational Dynamics. This concept helps us predict and understand how rotating objects behave, from spinning tops to planetary orbits, bringing everything together!"}
];
        let isPlaying = false;
