...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "W.E.P. Intro", "text": "Welcome future doctors! Today, we dive into Work, Energy, and Power – fundamental concepts linking force and motion. Understanding these principles is crucial for solving a wide range of physics problems in NEET."},
  {"title": "Work & Theorem", "text": "First, let's define Work done by a constant force, which is the product of force and displacement in the direction of the force. Then, we'll explore the Work-Energy Theorem, a powerful principle stating that the net work done on an object equals its change in kinetic energy."},
  {"title": "Potential Energy", "text": "Next, we unravel the concept of Potential Energy, stored energy due to an object's position or configuration. We'll specifically look at gravitational potential energy and elastic potential energy, essential for understanding conservative forces."},
  {"title": "Concept of Power", "text": "Moving on to Power, which quantifies the rate at which work is done or energy is transferred. High power means a lot of work is done quickly, a critical idea for analyzing engines and machines."},
  {"title": "Collisions & Conservation", "text": "Finally, we'll touch upon Collisions, where objects interact over a short period, and the energy transformations involved. This leads us to the vital laws of energy and momentum conservation, which are indispensable for analyzing complex interactions."}
];
        let isPlaying = false;
