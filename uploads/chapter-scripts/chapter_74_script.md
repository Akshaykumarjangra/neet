...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Life's Miracle", "text": "Ever wondered how life creates new life? Human reproduction is a fascinating journey of growth and renewal. In this chapter, we'll unravel the intricate processes that lead to the formation of a new individual."},
  {"title": "Reproductive Systems", "text": "Let's explore the key players: the male and female reproductive systems. From sperm production in the testes to egg formation in the ovaries, each system is perfectly designed for its crucial role."},
  {"title": "Sperm & Egg", "text": "Discover spermatogenesis, the continuous process forming millions of sperm, and oogenesis, where a single ovum matures each month. These specialized cells carry the genetic blueprints for a new life."},
  {"title": "Cycle & Fertilization", "text": "The menstrual cycle orchestrates the monthly preparation for pregnancy, culminating in ovulation. If sperm meets egg, fertilization occurs, marking the incredible fusion of genetic material."},
  {"title": "Development Journey", "text": "After fertilization, the zygote embarks on a nine-month journey of development within the uterus. The placenta, a vital connection, ensures nutrient exchange and supports the growing embryo and fetus."}
];
        let isPlaying = false;
