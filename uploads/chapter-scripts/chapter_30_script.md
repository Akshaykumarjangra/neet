...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Connect World", "text": "Welcome to Chapter 15: Communication Systems! Ever wondered how information travels across vast distances? We'll explore how electromagnetic waves make this global connection possible, from your phone to satellite broadcasts."},
  {"title": "System Blocks", "text": "Every communication system relies on key components: a transmitter, channel, and receiver. We'll also understand the crucial role of a high-frequency carrier signal in carrying our information effectively."},
  {"title": "Modulation Secrets", "text": "Modulation is the secret sauce that allows low-frequency audio signals to travel far. We'll delve into Amplitude Modulation (AM) and Frequency Modulation (FM), understanding their bandwidths and the important concept of modulation index."},
  {"title": "Signal Propagation", "text": "How do signals reach us? We'll examine different propagation modes like ground, sky, and space waves. Discover how antenna length plays a critical role in efficiently transmitting and receiving these signals."},
  {"title": "Digital Age", "text": "Beyond traditional methods, we'll explore the wonders of satellite communication, connecting remote corners of the world. Finally, we'll touch upon the fundamental shift towards digital communication, shaping our modern information age."}
];
        let isPlaying = false;
