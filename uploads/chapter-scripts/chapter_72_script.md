...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Floral Reproduction", "text": "Welcome, future doctors! Today, we uncover the intricate world of sexual reproduction in flowering plants. Flowers, those vibrant beauties, are actually sophisticated reproductive organs, housing both male and female structures."},
  {"title": "Gamete Formation", "text": "Inside the anther, pollen grains develop through microsporogenesis, carrying the male gametes. Concurrently, the ovule within the pistil forms the embryo sac, a crucial seven-celled structure with the egg cell ready for fertilization."},
  {"title": "Pollen Transfer", "text": "Pollination is the vital transfer of pollen from anther to stigma. This can be self-pollination within the same flower, or cross-pollination, often aided by wind, water, or fascinating animal pollinators like insects and birds."},
  {"title": "Unique Fertilization", "text": "Angiosperms exhibit a unique phenomenon: double fertilization! One male gamete fuses with the egg to form the zygote, while the other fuses with the polar nuclei, giving rise to the nutritive endosperm."},
  {"title": "Seed, Fruit Development", "text": "Post-fertilization, the zygote develops into an embryo, the ovule transforms into a protective seed, and the entire ovary matures into the fruit. Plants also employ clever outbreeding devices to promote genetic diversity."}
];
        let isPlaying = false;
