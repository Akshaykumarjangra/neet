...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Ecology Unveiled", "text": "Hello future doctors! Welcome to Chapter 13: Organisms and Populations. We're diving into Ecology, the science of life's intricate web, starting right from the individual organism and its group."},
  {"title": "Population Basics", "text": "An organism is an individual living entity, but when we group them, we get a population – a group of individuals of the same species in a given area. Understanding population density, or the number of individuals per unit area, is our first step to analyzing these groups."},
  {"title": "Growth Dynamics", "text": "Populations aren't static; they grow! We'll explore two key models: the rapid, unchecked exponential growth, and the more realistic logistic growth which considers environmental limits."},
  {"title": "Carrying Capacity", "text": "Logistic growth introduces a crucial concept: Carrying Capacity, or 'K'. This is the maximum population size an environment can sustainably support, influenced by limited resources and environmental resistance."},
  {"title": "Species Interactions", "text": "No population lives in isolation. We'll examine fascinating species interactions like competition, predation, mutualism, and commensalism, understanding how organisms influence each other's survival and growth."}
];
        let isPlaying = false;
