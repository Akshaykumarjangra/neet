...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Life's Continuity", "text": "Ever wondered how organisms grow, heal, or reproduce? It's all thanks to cell division! This fundamental process ensures the continuity of life by allowing a parent cell to divide and form new daughter cells, crucial for growth, repair, and reproduction in all living organisms."},
  {"title": "The Cell Cycle", "text": "Cell division isn't a simple event; it's part of a highly regulated sequence called the cell cycle. This cycle is broadly divided into Interphase, the preparatory phase, and the M-phase, where actual cell division occurs. Interphase is the longest, occupying about 90-95% of the cell cycle duration."},
  {"title": "Interphase Stages", "text": "Interphase itself comprises three stages: G₁, S, and G₂. The S phase is particularly vital as DNA replication takes place, doubling the DNA content from 2C to 4C, while the chromosome number remains unchanged. This ensures each daughter cell receives a complete genetic set."},
  {"title": "Mitosis Unveiled", "text": "Following Interphase, the cell enters the M-phase, or Mitosis. This division process produces two genetically identical, diploid daughter cells from a single parent cell. Mitosis is essential for growth and tissue repair in multicellular organisms."},
  {"title": "Mitosis Steps", "text": "Mitosis unfolds through four distinct stages: Prophase, Metaphase, Anaphase, and Telophase, often remembered by the acronym PMAT. Each stage involves precise changes in chromosome organization and cell structure to ensure accurate distribution of genetic material."}
];
        let isPlaying = false;
