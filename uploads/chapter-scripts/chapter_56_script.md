...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "s-Block Unveiled", "text": "Welcome to the s-block elements! These highly reactive metals are the superstars of the periodic table, eager to shed their outermost electrons. We'll explore Group 1 alkali metals and Group 2 alkaline earth metals, uncovering their unique properties and crucial compounds."},
  {"title": "Group 1: Alkali", "text": "Meet the Alkali Metals – Lithium, Sodium, Potassium, and more. With just one electron in their outermost s-orbital, they are incredibly reactive, readily forming +1 ions and always stored carefully to prevent vigorous reactions."},
  {"title": "Group 2: Earth", "text": "Now, let's turn to the Alkaline Earth Metals, like Beryllium, Magnesium, and Calcium. With two s-electrons, they are still reactive but less so than Group 1, forming +2 ions and exhibiting harder, higher melting point characteristics."},
  {"title": "Reactivity Trends", "text": "Witness their reactivity! Alkali metals explode with water, while alkaline earth metals react steadily. We'll also dive into the fascinating diagonal relationship and anomalous behavior shown by Lithium and Beryllium, due to their unique small size."},
  {"title": "Essential Compounds", "text": "Finally, discover the power of s-block compounds. From caustic soda (NaOH) used in soaps to quicklime (CaO) in cement, these elements form vital substances that shape industries and our daily lives."}
];
        let isPlaying = false;
