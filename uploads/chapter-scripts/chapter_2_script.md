...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Measurement's Core", "text": "Welcome, future doctors! Measurement is the very language of Physics, allowing us to quantify the world around us. In this chapter, we'll master the essential tools for precise observation and calculation."},
  {"title": "SI Units", "text": "Imagine a world without standard units – chaos! The International System of Units, or SI, provides a universal language for all physical quantities. We'll explore its fundamental and derived units crucial for NEET."},
  {"title": "Dimensional Analysis", "text": "Ever wondered how to check if an equation is correct or derive new relationships? Dimensional analysis is your superpower! Learn how to use dimensional formulae to validate equations and understand physical quantities deeply."},
  {"title": "Measurement Errors", "text": "Perfect measurements are rare, but understanding errors is key to accuracy. We'll delve into common pitfalls like least count, zero error, and parallax, learning how to identify and minimize them for reliable results."},
  {"title": "Significant Figures", "text": "How many digits should you trust in your measurement? Significant figures tell us the precision of our data, ensuring we report values meaningfully. Master this concept to avoid losing marks in calculations and understand error propagation."}
];
        let isPlaying = false;
