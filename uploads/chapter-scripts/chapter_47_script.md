...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Halo-Compounds Intro", "text": "Ever wondered about organic compounds with halogens? We're diving into Haloalkanes and Haloarenes, molecules where carbon meets elements like chlorine or bromine. Get ready to explore their unique structures and why they're so important!"},
  {"title": "Making Haloalkanes", "text": "How do we synthesize these fascinating molecules? We'll uncover key preparation methods, from direct halogenation to reactions involving alcohols and alkenes. Understanding their creation is the first step to mastering their chemistry."},
  {"title": "SN1 vs SN2", "text": "The heart of this chapter lies in understanding Nucleophilic Substitution reactions: SN1 and SN2. We'll dissect their mechanisms, exploring carbocation stability, the role of the leaving group, and how molecular structure dictates the pathway."},
  {"title": "Elimination & Trends", "text": "But wait, there's more! Beyond substitution, we'll also explore elimination reactions like E2, governed by rules like Saytzeff. Discover the factors influencing reactivity trends and how they impact product formation."},
  {"title": "Real-World Impact", "text": "From refrigerants to pesticides, halogenated compounds are everywhere. We'll conclude by examining their diverse applications and crucial environmental impacts, understanding their role in our world."}
];
        let isPlaying = false;
