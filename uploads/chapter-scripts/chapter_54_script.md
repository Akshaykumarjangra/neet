...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Why Atoms Bond?", "text": "Welcome to Chemical Bonding! Ever wondered why atoms don't just float around individually? They stick together through chemical bonds, forming stable molecules to achieve lower energy states."},
  {"title": "Ionic & Covalent", "text": "We'll explore two fundamental ways atoms bond: ionic bonds involve complete electron transfer, typically between metals and non-metals. Covalent bonds, on the other hand, involve the sharing of electrons, primarily between non-metals."},
  {"title": "Lewis & VSEPR", "text": "Visualize these bonds with Lewis structures, showing valence electron arrangements. Then, predict precise 3D molecular shapes using VSEPR Theory, where electron pairs repel to minimize repulsion and define geometry."},
  {"title": "Hybridization & Bonds", "text": "Dive deeper with hybridization, where atomic orbitals mix to form new, equivalent hybrid orbitals that dictate bond angles. Understand the crucial difference between strong sigma bonds, formed by head-on overlap, and weaker pi bonds, formed by sideways overlap."},
  {"title": "MOT & Polarity", "text": "Finally, explore Molecular Orbital Theory, where atomic orbitals combine to form molecular orbitals, explaining bond order and magnetic properties. We'll also learn about dipole moment, a measure of molecular polarity, determined by the sum of individual bond dipoles."}
];
        let isPlaying = false;
