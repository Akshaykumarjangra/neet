...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "What are Biomolecules?", "text": "Ever wondered what truly makes life tick at its core? It's all about Biomolecules! These intricate chemical compounds are the molecular architects and workers inside every living cell, orchestrating all life processes."},
  {"title": "Main Types", "text": "Biomolecules broadly fall into four major categories: Carbohydrates for energy, Proteins for structure and function, Lipids for storage and membranes, and Nucleic Acids for genetic information. Each group plays a distinct yet interconnected role."},
  {"title": "Monomers & Polymers", "text": "Think of them as molecular LEGOs! Many biomolecules are large polymers, built from smaller, repeating monomer units. Understanding these basic building blocks is key to grasping their complex structures and functions."},
  {"title": "Diverse Functions", "text": "From providing instant energy and forming cellular structures to catalyzing reactions and carrying hereditary information, biomolecules perform an astonishing array of functions. They are the versatile workhorses of the cell."},
  {"title": "Life's Foundation", "text": "Ultimately, understanding biomolecules is understanding life itself. They are the fundamental units that sustain all biological activities, making their study crucial for NEET and for comprehending the essence of biology."}
];
        let isPlaying = false;
