...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Ecosystem Basics", "text": "Welcome, future doctors! Today we unravel 'Ecosystems' – the fascinating units where living organisms interact with their non-living surroundings. We'll explore how energy flows, nutrients cycle, and life thrives in these interconnected systems."},
  {"title": "Energy's Journey", "text": "At the heart of every ecosystem is energy flow, starting from the sun and captured by producers. This energy then moves unidirectionally through different trophic levels, from primary consumers to top carnivores, losing some at each transfer."},
  {"title": "Pyramids of Life", "text": "Visualizing these trophic relationships are Ecological Pyramids, which can represent numbers, biomass, or energy at each level. Understanding their shape helps us grasp the efficiency and structure of an ecosystem."},
  {"title": "Measuring Productivity", "text": "Ecosystem productivity measures the rate at which biomass is produced, distinguishing between primary and secondary productivity. Primary productivity, by producers, is crucial for sustaining all other life forms."},
  {"title": "Nutrient Recycling", "text": "Finally, we delve into nutrient cycling, where essential elements like carbon, nitrogen, and phosphorus move between biotic and abiotic components. These biogeochemical cycles ensure the continuous availability of resources vital for life."}
];
        let isPlaying = false;
