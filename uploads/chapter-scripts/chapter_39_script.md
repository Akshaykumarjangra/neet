...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Solution Basics", "text": "Ever wondered how sugar dissolves perfectly in water? That's a solution – a homogeneous mixture where components are uniformly distributed. Understanding solutions is fundamental to chemistry and crucial for NEET!"},
  {"title": "Concentration Terms", "text": "How much solute is in your solvent? We use various concentration terms like molarity, molality, and mass percentage to precisely quantify this. These terms are essential for calculating solution properties accurately."},
  {"title": "Vapour Pressure Laws", "text": "Delve into how adding a solute affects a solvent's vapor pressure. We'll explore Raoult's Law for non-volatile solutes and Henry's Law for gases dissolved in liquids, explaining their real-world implications."},
  {"title": "Colligative Properties", "text": "Now, let's uncover colligative properties – those fascinating characteristics of solutions that depend solely on the number of solute particles, not their identity. They dictate many physical changes we observe."},
  {"title": "Key Colligative Effects", "text": "Discover how colligative properties manifest as boiling point elevation, freezing point depression, and osmotic pressure. These principles explain phenomena from antifreeze in car radiators to water movement in biological cells."}
];
        let isPlaying = false;
