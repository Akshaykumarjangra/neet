...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Colorful Elements", "text": "Ever wondered what gives us vibrant colors, powerful catalysts, and even biological essentials? Meet the d and f block elements, the fascinating transition and inner transition metals!"},
  {"title": "d-Block Secrets", "text": "Transition metals have partially filled d-orbitals, leading to their hallmark: variable oxidation states. This ability arises from the closely spaced (n-1)d and ns orbitals, allowing both to participate in bonding."},
  {"title": "Color & Catalysts", "text": "Their stunning colors come from d-d transitions, where electrons jump between split d-orbitals by absorbing specific light. Plus, their variable states make them amazing catalysts, speeding up countless reactions!"},
  {"title": "Lanthanide Contraction", "text": "Moving to the f-block, the lanthanides showcase 'lanthanide contraction' – a gradual size decrease due to poor 4f electron shielding. This makes 4d and 5d elements surprisingly similar in size and properties!"},
  {"title": "Magnetic Marvels", "text": "Many d and f block elements are magnetic, especially if they have unpaired electrons! From powerful oxidizers like K₂Cr₂O₇ and KMnO₄ to essential industrial catalysts, their applications are truly vast. Master these concepts for NEET!"}
];
        let isPlaying = false;
