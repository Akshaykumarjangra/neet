...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Moving Charges Intro", "text": "Ever wondered how electricity creates magnetism? This chapter, \"Moving Charges and Magnetism,\" unveils the fascinating link, exploring how moving charges generate magnetic fields and the forces they experience."},
  {"title": "Lorentz Force", "text": "At the heart of it all is the Lorentz Force! Discover how charged particles moving through magnetic fields experience a force, often leading to intriguing circular or helical paths fundamental to many applications."},
  {"title": "Magnetic Fields", "text": "How do currents create fields? We'll use Biot-Savart Law and Ampere's Law to calculate magnetic fields generated by current-carrying wires, like the field around a long straight conductor. Understand the direction and strength of these fields."},
  {"title": "Force Conductors", "text": "Just as moving charges feel a force, an entire current-carrying conductor placed in a magnetic field experiences a net force. Learn how to calculate this force and predict its direction using Fleming's Left-Hand Rule."},
  {"title": "Torque Loop", "text": "Finally, we'll see how a current loop in a magnetic field experiences a torque, forming the basis of electric motors. Grasp the concept of magnetic dipole moment and how it governs this rotational effect."}
];
        let isPlaying = false;
