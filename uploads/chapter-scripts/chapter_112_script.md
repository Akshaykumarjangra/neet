...
<body>
    ...
    <script>
        ...
        const scenes = [
  {"title": "Plant Life Journey", "text": "From a tiny seed to a magnificent plant, how does this transformation occur? This chapter explores the fundamental processes of plant growth and development, crucial for all life on Earth."},
  {"title": "Growth vs. Development", "text": "Growth is the irreversible, permanent increase in size or mass of a plant. Development, however, is a broader term encompassing all changes from germination to senescence, including growth, differentiation, and maturation."},
  {"title": "Unique Plant Growth", "text": "Unlike animals, plants exhibit indeterminate growth, meaning they can grow continuously throughout their life. This remarkable ability is due to specialized regions called meristems."},
  {"title": "Differentiation Pathway", "text": "Cells undergo differentiation to become specialized, but they can also dedifferentiate to regain meristematic activity. These dedifferentiated cells can then redifferentiate into new cell types, showcasing plant plasticity."},
  {"title": "Growth Phases & Models", "text": "Plant growth proceeds through distinct meristematic, elongation, and maturation phases. We'll also learn about mathematical models like arithmetic growth (Lt = L₀ + rt) and geometric growth (W₁ = W₀e^(rt)) to quantify these processes."}
];
        let isPlaying = false;
